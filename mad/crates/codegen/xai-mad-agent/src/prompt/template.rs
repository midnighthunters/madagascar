...
/// The base prompt template source, exposed for `mad prompt --section template`.
...
/// Apply-patch prompt template source, exposed for `mad prompt --section apply-patch-template`.
...
mod tests {
    ...
    /// Build a TemplateRenderer with the standard mad-build tool kinds.
