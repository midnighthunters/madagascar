...
//!
//! Run with: cargo test -p xai-mad-mcp --test repro_sse_flood -- --nocapture
...
use xai_mad_mcp::mcp_http_client::{McpHttpClient, WarnBudget};
use xai_mad_mcp::rmcp::ServiceExt;
use xai_mad_mcp::rmcp::transport::StreamableHttpClientTransport;
use xai_mad_mcp::rmcp::transport::streamable_http_client::StreamableHttpClientTransportConfig;
