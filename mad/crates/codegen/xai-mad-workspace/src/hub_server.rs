...
use xai_mad_tools::implementations::mad_build::scheduler::interval::interval_to_human;
use xai_mad_tools::implementations::mad_build::scheduler::types::{
    SchedulerCommand, SchedulerHandle,
};
use xai_mad_tools::registry::types::FinalizedToolset;
use xai_mad_tools::types::resources::Terminal;
use xai_mad_workspace_types::rpc::workspace::{
...
static WORKSPACE_RPC_CALLER_MISMATCH_TOTAL: std::sync::LazyLock<IntCounterVec> =
    std::sync::LazyLock::new(|| {
        register_int_counter_vec!(
            "mad_workspace_rpc_caller_mismatch_total",
...
static WORKSPACE_RPC_MUTATION_TOTAL: std::sync::LazyLock<IntCounterVec> =
    std::sync::LazyLock::new(|| {
        register_int_counter_vec!(
            "mad_workspace_rpc_mutation_total",
...
static WORKSPACE_RPC_REQUESTS_TOTAL: std::sync::LazyLock<IntCounterVec> =
    std::sync::LazyLock::new(|| {
        register_int_counter_vec!(
            "mad_workspace_rpc_requests_total",
...
static WORKSPACE_RPC_ERRORS_TOTAL: std::sync::LazyLock<IntCounterVec> =
    std::sync::LazyLock::new(|| {
        register_int_counter_vec!(
            "mad_workspace_rpc_errors_total",
...
static WORKSPACE_RPC_DURATION_SECONDS: std::sync::LazyLock<HistogramVec> =
    std::sync::LazyLock::new(|| {
        register_histogram_vec!(
            "mad_workspace_rpc_duration_seconds",
...
) -> Vec<xai_mad_workspace_types::rpc::workspace::BackgroundTaskSummaryWire> {
    use xai_mad_tools::computer::types::TaskKind;
    use xai_mad_tools::types::resources::Terminal;
    use xai_mad_tools::types::tool::ToolKind;
    use xai_mad_workspace_types::rpc::workspace::BackgroundTaskSummaryWire;
    let terminal = {
...
async fn list_session_todos(
    toolset: &xai_mad_tools::registry::types::FinalizedToolset,
) -> Vec<xai_mad_workspace_types::rpc::workspace::TodoSummaryWire> {
    use xai_mad_tools::implementations::mad_build::todo::{TodoState, TodoStatus};
    use xai_mad_tools::types::resources::State;
    use xai_mad_workspace_types::rpc::workspace::TodoSummaryWire;
    let res = toolset.resources.lock().await;
...
impl WorkspaceRpcHandler {
    ...
    async fn dispatch(
        ...
        use xai_mad_workspace_types::rpc::git::{GitBranchInfoReq, GitMetadataReq};
        use xai_mad_workspace_types::rpc::search::FuzzyStatusReq;
        use xai_mad_workspace_types::rpc::skills::DiscoverPluginsReq;
        use xai_mad_workspace_types::rpc::workspace::{
        ...
        use xai_mad_workspace_types::rpc::worktree::WorktreeCreateSyncReq;
...
mod tests {
    ...
    async fn list_background_tasks_rpc_stays_truthful_across_rebinds() {
        ...
        use xai_mad_workspace_types::rpc::workspace::ListBackgroundTasksResponse;
        let handle = make_handle();
        ...
        let read_only = ToolServerConfig {
            tools: vec![tc(
                ...
                Some(xai_mad_tools::types::tool::ToolKind::Read),
            )],
    ...
    async fn handle_call_records_rpc_metrics_and_collapses_unknown_method() {
        ...
        let has_bogus_series = prometheus::gather()
            .iter()
            .filter(|mf| mf.name() == "mad_workspace_rpc_requests_total")
