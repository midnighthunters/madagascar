//! AcpFsAdapter: implements `xai-mad-tools::AsyncFileSystem` using ACP gateway calls.
//!
//! This adapter enables file tool execution over ACP (remote filesystem).
//! It translates xai-mad-tools' `AsyncFileSystem` trait into ACP protocol calls:
...
use xai_mad_tools::computer::types::{AsyncFileSystem, ComputerError};

/// Wraps xai-mad-shell's ACP gateway to satisfy xai-mad-tools' AsyncFileSystem.
///
