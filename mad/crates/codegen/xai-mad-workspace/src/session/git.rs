...
///
/// ```
/// use xai_mad_workspace::session::git::normalize_repo_url;
///
/// assert_eq!(
...
///
/// 1. `supplied_cwd` is a mad-managed worktree (`~/.mad/worktrees/...`).
...
pub fn restore_code_checkout_allowed(supplied_cwd: &Path, persisted_cwd: Option<&str>) -> bool {
    let worktrees_dir = xai_mad_tools::util::mad_home::mad_home().join("worktrees");
...
const REWIND_GIT_ENV: &str = "MAD_WORKSPACE_REWIND_GIT";
...
pub fn git_rewind_enabled() -> bool {
    xai_mad_config::env_bool(REWIND_GIT_ENV).unwrap_or(false)
}
...
const DEFAULT_EXCLUDES_MARKER: &str = "mad default excludes";
...
# mad default excludes (local-only; seeded by the workspace git_commit op)
.mad/
node_modules/
.env
.env.*
...
mod tests {
    ...
    fn test_effective_worktree_cwd_empty_offset() {
        let result =
            effective_worktree_cwd("/home/user/.mad/worktrees/repo/ab-123-a", Path::new(""));
        assert_eq!(result, "/home/user/.mad/worktrees/repo/ab-123-a");
    }
    #[test]
    fn test_effective_worktree_cwd_single_level_offset() {
        let result =
            effective_worktree_cwd("/home/user/.mad/worktrees/repo/ab-123-a", Path::new("src"));
        assert_eq!(result, "/home/user/.mad/worktrees/repo/ab-123-a/src");
    }
    #[test]
    fn test_effective_worktree_cwd_nested_offset() {
        let result = effective_worktree_cwd(
            "/home/user/.mad/worktrees/repo/ab-123-b",
            Path::new("packages/frontend/src"),
        );
        assert_eq!(
            result,
            "/home/user/.mad/worktrees/repo/ab-123-b/packages/frontend/src"
        );
    }
    #[test]
    ...
    fn test_effective_cwd_roundtrip_with_compute_offset() {
        ...
        let worktree_root = "/home/user/.mad/worktrees/myrepo/ab-test-a";
...
mod restore_code_tests {
    ...
    async fn stash_before_destructive_op_dirty_tracked_returns_ref() {
        ...
        assert!(
            list.contains("mad: pre-test sess-2"),
    ...
    fn restore_code_checkout_allowed_worktree_cwd_is_allowed() {
        let worktrees = Path::new("/home/u/.mad/worktrees");
        assert!(restore_code_checkout_allowed_in(
            Path::new("/home/u/.mad/worktrees/home-u-repo/2026-05-22-9f2e51ce"),
            Some("/home/u/repo"),
            worktrees,
        ));
    }
    ...
    fn restore_code_checkout_allowed_source_repo_with_worktree_session_is_refused() {
        ...
        assert!(!restore_code_checkout_allowed_in(
            Path::new("/home/u/repo"),
            Some("/home/u/.mad/worktrees/home-u-repo/2026-05-22-9f2e51ce"),
            worktrees,
        ));
    }
    #[test]
