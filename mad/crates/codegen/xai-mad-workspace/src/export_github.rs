...
use xai_mad_workspace_types::rpc::export_github::{ExportGithubError, ExportGithubResponse};
...
const AUTHOR_NAME: &str = "Mad";
const AUTHOR_EMAIL: &str = "mad-export@users.noreply.github.com";
...
async fn commit_if_dirty(dir: &Path, message: Option<&str>) -> Result<bool, ExportGithubFailure> {
    ...
    let message = message.unwrap_or("Export from Mad");
