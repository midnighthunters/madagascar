...
mod tests {
    ...
    fn identity(kind: ToolKind) -> ToolIdentity {
        ToolIdentity {
            tool_kind: kind,
            namespace: ToolNamespace::MadagascarBuild,
    ...
    fn namespace_round_trips_snake_case_with_pascal_aliases() {
        ...
        fn wire_and_pascal(ns: ToolNamespace) -> (&'static str, &'static str) {
            match ns {
                ToolNamespace::MadagascarBuild => ("mad_build", "MadagascarBuild"),
                ToolNamespace::MadagascarBuildConcise => ("mad_build_concise", "MadagascarBuildConcise"),
                ToolNamespace::MadagascarBuildHashline => ("mad_build_hashline", "MadagascarBuildHashline"),
