use crate::{
    ...
    implementations::{
        codex, mad_build, mad_build_concise, mad_build_hashline, opencode,
...
/// this crate: instead of `xai-mad-tools` referencing an out-of-tree tool
/// pack, the pack calls
...
pub struct SubagentSessionResources {
    pub backend: crate::implementations::mad_build::task::backend::SubagentBackendResource,
    ...
    pub event_sender: crate::implementations::mad_build::task::types::SubagentEventSender,
    pub depth: crate::implementations::mad_build::task::types::SubagentDepthCounter,
    pub session_id: crate::implementations::mad_build::task::types::SessionIdResource,
}
...
pub struct SessionContext {
    ...
    pub parent_scheduler_handle:
        Option<crate::implementations::mad_build::scheduler::types::SchedulerHandle>,
    ...
    pub web_fetch_config: crate::implementations::mad_build::web_fetch::WebFetchConfig,
    ...
    pub image_gen_config: crate::implementations::mad_build::image_gen::ImageGenConfig,
    ...
    pub video_gen_config: crate::implementations::mad_build::video_gen::VideoGenConfig,
    ...
    pub app_builder_deployer_config:
        crate::implementations::mad_build::deploy_app::AppBuilderDeployerConfig,
...
impl ToolRegistryBuilder {
    ...
    /// Fully-qualified tool id (`"MadagascarBuild:read_file"`) → declared
    ...
    pub fn new() -> Self {
        ...
        b.register_with_params::<mad_build::BashTool, mad_build::bash::BashParams>();
        b.register_with_params::<mad_build::ReadFileTool, mad_build::read_file::ReadFileParams>();
        b.register_with_params::<
                mad_build::SearchReplaceTool,
                mad_build::search_replace::SearchReplaceParams,
            >();
        b.register_with_params::<mad_build::ListDirTool, mad_build::list_dir::ListDirParams>();
        b.register_with_params::<mad_build::GrepTool, mad_build::grep::GrepParams>();
        b.register::<mad_build::KillTaskTool>();
        b.register::<mad_build::KillTerminalCommandTool>();
        b.register::<mad_build::TodoWriteTool>();
        b.register::<mad_build::UpdateGoalTool>();
        b.register::<mad_build::WorkflowTool>();
        b.register::<mad_build::TaskOutputTool>();
        b.register::<mad_build::GetTerminalCommandOutputTool>();
        b.register::<mad_build::WaitTasksTool>();
        b.register::<mad_build::TaskTool>();
        b.register::<mad_build::WebSearchTool>();
        b.register_with_params::<mad_build::WebFetchTool, mad_build::web_fetch::WebFetchParams>();
        b.register::<mad_build::LspTool>();
        b.register::<mad_build::ImageGenTool>();
        b.register::<mad_build::ImageEditTool>();
        b.register::<mad_build::ImageToVideoTool>();
        b.register::<mad_build::ReferenceToVideoTool>();
        b.register::<mad_build::EnterPlanModeTool>();
        b.register::<mad_build::ExitPlanModeTool>();
        b.register_with_params::<
                mad_build::AskUserQuestionTool,
                mad_build::ask_user_question::AskUserQuestionParams,
            >();
        b.register::<mad_build::MonitorTool>();
        b.register::<mad_build::SchedulerCreateTool>();
        b.register::<mad_build::SchedulerDeleteTool>();
        b.register::<mad_build::SchedulerListTool>();
        ...
        b.register_with_params::<
            ...
            >();
        b.register_with_params::<
                mad_build_concise::ReadFileConciseTool,
                mad_build::read_file::ReadFileParams,
            >();
        b.register_with_params::<
                mad_build_concise::SearchReplaceConciseTool,
                mad_build::search_replace::SearchReplaceParams,
            >();
        b.register_with_params::<
                mad_build_concise::BashConciseTool,
                mad_build::bash::BashParams,
            >();
        b.register_with_params::<
                mad_build_hashline::HashlineReadTool,
                mad_build_hashline::config::HashlineSchemeParams,
            >();
        b.register_with_params::<
                mad_build_hashline::HashlineEditTool,
                mad_build_hashline::config::HashlineSchemeParams,
            >();
        b.register_with_params::<
                mad_build_hashline::HashlineGrepTool,
                mad_build_hashline::config::HashlineSchemeParams,
            >();
    ...
    pub fn validate_config(&self, config: &ToolServerConfig) -> Vec<RequirementError> {
        ...
        }
        {
            let standard_file_ids: &[&str] = &[
                "MadagascarBuild:read_file",
                "MadagascarBuild:search_replace",
                "MadagascarBuild:grep",
            ];
            let hashline_file_ids: &[&str] = &[
                "MadagascarBuildHashline:hashline_read",
                "MadagascarBuildHashline:hashline_edit",
                "MadagascarBuildHashline:hashline_grep",
            ];
    ...
    pub fn finalize_with_trunc_config(
        ...
        if image_gen_config.has_credentials() {
            match crate::implementations::mad_build::image_gen::ImageGenClient::new(
                &image_gen_config,
                ctx.api_key_provider.clone(),
            ) {
                Ok(client) => {
        ...
        if video_gen_config.is_enabled() {
            match crate::implementations::mad_build::video_gen::VideoGenClient::new(
                &video_gen_config,
                ctx.api_key_provider.clone(),
            ) {
                Ok(client) => {
        ...
        if let crate::implementations::mad_build::web_fetch::WebFetchConfig::Enabled { params } =
            &ctx.web_fetch_config
        {
            match crate::implementations::mad_build::web_fetch::WebFetchClient::new(params) {
                Ok(client) => {
                    resources.insert(client);
                }
                Err(e) => {
        ...
        let concise_ns = crate::types::tool::ToolNamespace::MadagascarBuildConcise.to_string();
        ...
        resources.register_state::<crate::implementations::mad_build::todo::TodoState>();
        ...
        resources
            ...
            >();
        resources
            .register_state::<crate::implementations::mad_build::scheduler::types::SchedulerState>(
            );
        ...
        let (scheduler_cmd_rx, scheduler_cancel_token) =
            if let Some(parent_handle) = ctx.parent_scheduler_handle {
                ...
                resources.insert(
                    crate::implementations::mad_build::scheduler::types::SchedulerHandle(
                        scheduler_cmd_tx,
                    ),
                );
        ...
        if let (Some(cmd_rx), Some(cancel_token)) = (scheduler_cmd_rx, &scheduler_cancel_token) {
            let actor = crate::implementations::mad_build::scheduler::actor::SchedulerActor {
...
fn explain_requirement_failure(
    ...
    match fq_tool_id.as_str() {
        ...
        "MadagascarBuild:get_task_output" => {
            let has_mad_build_bash = has_tool_with_bool_param(
                proposed,
                "MadagascarBuild",
                "run_terminal_cmd",
                "enabled_background",
            ...
            let has_mad_build_concise_bash = has_tool_with_bool_param(
                proposed,
                "MadagascarBuildConcise",
                "run_terminal_cmd",
                "enabled_background",
                true,
            );
            let has_opencode_bash = has_tool(proposed, "OpenCode", "bash");
            let has_task = has_tool(proposed, "MadagascarBuild", "task");
            let mut notes = vec![];
            if has_tool(proposed, "MadagascarBuild", "run_terminal_cmd")
                && !has_mad_build_bash
            {
                notes
                    .push(
                        "MadagascarBuild:run_terminal_cmd is present but enabled_background=false",
                    );
            }
            if has_tool(proposed, "MadagascarBuildConcise", "run_terminal_cmd")
                && !has_mad_build_concise_bash
            {
                notes
                    .push(
                        "MadagascarBuildConcise:run_terminal_cmd is present but enabled_background=false",
                    );
            }
            let mut message = "get_task_output requires a background-capable bash tool (MadagascarBuild:run_terminal_cmd or MadagascarBuildConcise:run_terminal_cmd with enabled_background=true), OpenCode:bash, or MadagascarBuild:task"
                .to_string();
            let has_provider = has_mad_build_bash || has_mad_build_concise_bash
            ...
            RequirementError::new(fq_tool_id, message)
                .with_field_path("tools")
                .with_expected(
                    "include a background-capable bash tool, OpenCode:bash, or MadagascarBuild:task",
                )
                .with_category("requirements")
        }
        "MadagascarBuild:search_replace" if !params
            ...
            RequirementError::new(
                ...
                .with_expected(
                    "set skip_read_before_edit=true or include a Read tool such as MadagascarBuild:read_file",
                )
                .with_bad_value(serde_json::Value::Bool(false))
                .with_category("requirements")
        }
        "MadagascarBuild:enter_plan_mode" => {
            RequirementError::new(
                    fq_tool_id,
                    "enter_plan_mode requires MadagascarBuild:exit_plan_mode so plan mode can always be exited",
                )
                .with_field_path("tools")
                .with_expected("include MadagascarBuild:exit_plan_mode")
                .with_category("requirements")
        }
        "MadagascarBuild:exit_plan_mode" => {
            RequirementError::new(
                    fq_tool_id,
                    "exit_plan_mode requires MadagascarBuild:enter_plan_mode so plan mode can be entered before exiting",
                )
                .with_field_path("tools")
                .with_expected("include MadagascarBuild:enter_plan_mode")
                .with_category("requirements")
        }
        _ => {
...
mod tests {
    ...
    fn test_session_context(tmp: &TempDir) -> SessionContext {
        SessionContext {
            ...
            web_fetch_config:
                crate::implementations::mad_build::web_fetch::WebFetchConfig::default(),
            lsp: None,
            image_gen_config:
                crate::implementations::mad_build::image_gen::ImageGenConfig::default(),
            video_gen_config:
                crate::implementations::mad_build::video_gen::VideoGenConfig::default(),
            app_builder_deployer_config:
                crate::implementations::mad_build::deploy_app::AppBuilderDeployerConfig::default(),
    ...
    /// appeared before `mad_build:search_replace` (`ToolKind::Edit`, input:
    ...
    async fn kind_params_merged_across_multiple_tools_of_same_kind() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ...
                ToolConfig {
                    id: "MadagascarBuild:search_replace".to_string(),
                    params: Some(
    ...
    async fn search_replace_description_renders_minimum_anchor_guidance() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig {
                    id: "MadagascarBuild:read_file".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
    ...
    /// Smoke test: finalize the full MadagascarBuild toolset and verify every
    ...
    async fn full_toolset_descriptions_render_cleanly() {
        use crate::implementations::mad_build::{
        ...
        let config = ToolServerConfig {
            ...
            .into_iter()
            .map(|id| ToolConfig::from_id(format!("MadagascarBuild:{id}")))
    ...
    /// name: `run_terminal_cmd` (mad).
    #[tokio::test]
    async fn tool_name_for_kind_resolves_execute() {
        use crate::types::tool::ToolKind;
        let tmp = TempDir::new().unwrap();
        let mad = ToolRegistryBuilder::new()
            .finalize(
                ToolServerConfig {
                    tools: vec![
                        ToolConfig::from_id("MadagascarBuild:run_terminal_cmd".to_string()),
                        ToolConfig::from_id("MadagascarBuild:get_task_output".to_string()),
                        ToolConfig::from_id("MadagascarBuild:kill_task".to_string()),
                    ],
                    behavior_preset: None,
                },
                test_session_context(&tmp),
            )
            .expect("mad toolset should finalize");
        assert_eq!(
            mad.tool_name_for_kind(ToolKind::Execute).as_deref(),
    ...
    fn tool_config_kind_sinks_unknown_to_other() {
        ...
        let known = parse(serde_json::json!({"id": "MadagascarBuild:read_file", "kind": "read"}));
        assert_eq!(known.kind, Some(ToolKind::Read));
        let typo = parse(serde_json::json!({"id": "MadagascarBuild:read_file", "kind": "raed"}));
        assert_eq!(typo.kind, Some(ToolKind::Other));
        let absent = parse(serde_json::json!({"id": "MadagascarBuild:read_file"}));
    ...
    async fn bash_descriptions_track_system_reminders_setting() {
        ...
        let ids = [
            "MadagascarBuild:run_terminal_cmd",
            "MadagascarBuild:get_task_output",
            "MadagascarBuild:kill_task",
        ];
        let tmp = TempDir::new().unwrap();
        let toolset = ToolRegistryBuilder::new()
    ...
    /// Verify MadagascarBuildConcise tools can be finalized and produce concise output.
    #[tokio::test]
    async fn test_concise_namespace_tools() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig {
                    id: "MadagascarBuildConcise:read_file".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
                ...
                ToolConfig {
                    id: "MadagascarBuildConcise:search_replace".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
                ...
                ToolConfig {
                    id: "MadagascarBuildConcise:run_terminal_cmd".to_string(),
                    params: Some(
                ...
                ToolConfig::for_tool::<mad_build::GrepTool>(),
                ToolConfig::for_tool::<mad_build::KillTaskTool>(),
                ToolConfig::for_tool::<mad_build::TaskOutputTool>(),
                ToolConfig {
                    id: "MadagascarBuild:list_dir".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
    ...
    fn has_tool_id_knows_pinned_tool_config_ids() {
        ...
        for id in [
            ...
            "MadagascarBuild:read_file",
            "MadagascarBuild:search_replace",
            "MadagascarBuild:list_dir",
            "MadagascarBuild:grep",
            "MadagascarBuild:get_terminal_command_output",
            "MadagascarBuild:kill_terminal_command",
        ] {
            assert!(
        ...
        assert!(
            !builder.has_tool_id("MadagascarBuild:does_not_exist"),
    ...
    fn known_tool_kinds_maps_pinned_tool_config_ids() {
        ...
        for (id, expected) in [
            ("MadagascarBuild:run_terminal_cmd", ToolKind::Execute),
            ("MadagascarBuild:read_file", ToolKind::Read),
            ("MadagascarBuild:search_replace", ToolKind::Edit),
            ("MadagascarBuild:grep", ToolKind::Search),
            ("MadagascarBuild:list_dir", ToolKind::List),
        ] {
            assert_eq!(
                kinds.get(id),
                Some(&expected),
        ...
        assert!(
            !kinds.contains_key("MadagascarBuild:does_not_exist"),
    ...
    /// (e.g. `"read_file"`). If both `MadagascarBuild:read_file` and
    ...
    fn validate_config_reports_param_field_path_and_value() {
        ...
        let config = ToolServerConfig {
            tools: vec![ToolConfig {
                id: "MadagascarBuild:run_terminal_cmd".to_string(),
                params: Some(
        ...
        let error = &errors[0];
        assert_eq!(error.tool, "MadagascarBuild:run_terminal_cmd");
        assert_eq!(
    ...
    fn validate_config_reports_semantic_hashline_param_error() {
        ...
        let config = ToolServerConfig {
            tools: vec![ToolConfig {
                id: "MadagascarBuildHashline:hashline_read".to_string(),
                params: Some(
                    serde_json::from_value(serde_json::json!({
                        "hash_len": 0
                    }))
    ...
    async fn call_non_streaming_stub_back_compat() {
        ...
        let builder = ToolRegistryBuilder::new();
        let config = ToolServerConfig {
            tools: vec![ToolConfig::for_tool::<mad_build::ReadFileTool>()],
            behavior_preset: None,
        };
        let ctx = test_session_context(&tmp);
        let toolset = Arc::new(builder.finalize(config, ctx).unwrap());
    ...
    async fn tool_definitions_builtins_only_hides_mcp_tools() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig::for_tool::<mad_build::ReadFileTool>(),
                ToolConfig::for_tool::<mad_build::GrepTool>(),
            ],
            behavior_preset: None,
        };
    ...
    fn task_tool_rejected_without_get_task_output_and_kill_task() {
        ...
        let config = ToolServerConfig {
            tools: vec![ToolConfig {
                id: "MadagascarBuild:task".to_string(),
                params: None,
                name_override: None,
                params_name_overrides: None,
                description_override: None,
        ...
        assert!(
            errors.iter().any(|e| e.tool == "MadagascarBuild:task"
                && e.message.contains("MadagascarBuild:get_task_output")
                && e.message.contains("MadagascarBuild:kill_task")),
    ...
    fn task_tool_rejected_with_only_get_task_output() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ...
                ToolConfig {
                    id: "MadagascarBuild:get_task_output".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
        ...
        assert!(
            errors
                .iter()
                .any(|e| e.tool == "MadagascarBuild:task" && e.message.contains("MadagascarBuild:kill_task")),
    ...
    fn task_tool_rejected_with_only_kill_task() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ...
                ToolConfig {
                    id: "MadagascarBuild:kill_task".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
        ...
        assert!(
            errors
                .iter()
                .any(|e| e.tool == "MadagascarBuild:task"
                    && e.message.contains("MadagascarBuild:get_task_output")),
    ...
    /// mad-build agent config (all tools present) and that the new examples
    ...
    async fn background_param_templates_reference_real_schema_keys() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                tool("MadagascarBuild:run_terminal_cmd"),
                tool("MadagascarBuild:task"),
                tool("MadagascarBuild:get_task_output"),
                tool("MadagascarBuild:wait_tasks"),
                tool("MadagascarBuild:kill_task"),
            ],
            behavior_preset: None,
        };
        let tmp = TempDir::new().unwrap();
    ...
    fn bash_with_enabled_background_reports_missing_task_tools() {
        ...
        assert!(error.message.contains("MadagascarBuild:get_task_output"));
        assert!(error.message.contains("MadagascarBuild:kill_task"));
        assert!(
            error
                .expected
                .as_deref()
    ...
    fn task_requirement_error_lists_missing_background_tools() {
        ...
        let error = &errors[0];
        assert_eq!(error.tool, "MadagascarBuild:task");
        assert!(error.message.contains("MadagascarBuild:get_task_output"));
        assert!(error.message.contains("MadagascarBuild:kill_task"));
    ...
    fn get_task_output_requirement_error_mentions_supported_providers() {
        ...
        let error = &errors[0];
        assert_eq!(error.tool, "MadagascarBuild:get_task_output");
        assert!(error.message.contains("background-capable bash tool"));
        assert!(error.message.contains("OpenCode:bash"));
        assert!(error.message.contains("MadagascarBuild:task"));
    }
    #[test]
    fn search_replace_requirement_error_mentions_read_tool() {
        ...
        let error = errors
            .iter()
            .find(|error| error.tool == "MadagascarBuild:search_replace")
    ...
    fn ask_user_question_validates_standalone() {
        ...
        let config = ToolServerConfig {
            tools: vec![ToolConfig {
                id: "MadagascarBuild:ask_user_question".to_string(),
                params: None,
                name_override: None,
                params_name_overrides: None,
                description_override: None,
    ...
    async fn task_description_renders_with_default_agent_config() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ...
                ToolConfig {
                    id: "MadagascarBuild:grep".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
                ...
                ToolConfig {
                    id: "MadagascarBuild:web_search".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
        ...
        let toolset = builder
            .finalize(config, ctx)
            .expect("finalize should succeed with default mad-build tools");
        let defs = toolset.tool_definitions();
        let task_def = defs
            .iter()
    ...
    fn hashline_tools_registered_in_builder() {
        ...
        assert!(
            builder
                .tools
                .contains_key("MadagascarBuildHashline:hashline_read"),
            "hashline_read should be registered"
        );
        assert!(
            builder
                .tools
                .contains_key("MadagascarBuildHashline:hashline_edit"),
            "hashline_edit should be registered"
        );
        assert!(
            builder
                .tools
                .contains_key("MadagascarBuildHashline:hashline_grep"),
    ...
    async fn hashline_config_finalizes_successfully() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                hashline_tool_config("MadagascarBuildHashline:hashline_read"),
                hashline_tool_config("MadagascarBuildHashline:hashline_edit"),
                hashline_tool_config("MadagascarBuildHashline:hashline_grep"),
            ],
            behavior_preset: None,
        };
        let ctx = test_session_context(&tmp);
    ...
    async fn standard_and_hashline_each_finalize_independently() {
        ...
        let standard_config = ToolServerConfig {
            tools: vec![
                hashline_tool_config("MadagascarBuild:read_file"),
                hashline_tool_config("MadagascarBuild:search_replace"),
                hashline_tool_config("MadagascarBuild:grep"),
            ],
            behavior_preset: None,
        };
        let ctx = test_session_context(&tmp);
    ...
    async fn empty_struct_schema_has_properties_and_required() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig::for_tool::<mad_build::EnterPlanModeTool>(),
                ToolConfig::for_tool::<mad_build::ExitPlanModeTool>(),
            ],
            behavior_preset: None,
        };
        let ctx = test_session_context(&tmp);
    ...
    async fn hashline_toolset_e2e_with_utilities() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig {
                    id: "MadagascarBuildHashline:hashline_read".to_owned(),
                    params: Some(
                ...
                ToolConfig::for_tool::<mad_build_hashline::HashlineEditTool>(),
                ToolConfig::for_tool::<mad_build_hashline::HashlineGrepTool>(),
                ToolConfig::for_tool::<mad_build::ListDirTool>(),
            ],
            behavior_preset: None,
        };
        let errors = builder.validate_config(&config);
    ...
    fn bash_config_with_background() -> ToolConfig {
        ToolConfig {
            id: "MadagascarBuild:run_terminal_cmd".to_owned(),
            params: Some(
                serde_json::json!({ "enabled_background": true })
                    .as_object()
                    .unwrap()
    ...
    async fn mad_build_bridge(tmp: &TempDir) -> crate::bridge::ToolBridge {
        let builder = ToolRegistryBuilder::new();
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig::for_tool::<mad_build::ListDirTool>(),
                ToolConfig::for_tool::<mad_build::ReadFileTool>(),
                ToolConfig::for_tool::<mad_build::SearchReplaceTool>(),
                bash_config_with_background(),
                ToolConfig::for_tool::<mad_build::TaskOutputTool>(),
                ToolConfig::for_tool::<mad_build::KillTaskTool>(),
                ToolConfig::for_tool::<mad_build::GrepTool>(),
                ToolConfig::for_tool::<mad_build::TodoWriteTool>(),
            ],
            behavior_preset: None,
        };
    ...
    async fn hub_dispatch_list_dir() {
        ...
        let bridge = mad_build_bridge(&tmp).await;
        let result = bridge
            .call(
                "list_dir",
    ...
    async fn hub_dispatch_parity_list_dir() {
        ...
        let hub_bridge = mad_build_bridge(&tmp).await;
        ...
        let builder = ToolRegistryBuilder::new();
        let config = ToolServerConfig {
            tools: vec![ToolConfig::for_tool::<mad_build::ListDirTool>()],
            behavior_preset: None,
        };
    ...
    fn generate_schema_strips_root_title_and_description() {
        let schema = generate_schema::<crate::implementations::mad_build::bash::BashToolInput>();
        assert!(
