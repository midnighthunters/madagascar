...
use crate::implementations::mad_build::ask_user_question::AskUserQuestionInput;
use crate::implementations::mad_build::enter_plan_mode::EnterPlanModeInput;
use crate::implementations::mad_build::exit_plan_mode::ExitPlanModeInput;
use crate::implementations::mad_build::grep::GrepSearchInput;
use crate::implementations::mad_build::image_edit::ImageEditInput;
use crate::implementations::mad_build::image_gen::ImageGenInput;
use crate::implementations::mad_build::list_dir::ListDirInput;
use crate::implementations::mad_build::read_file::ReadFileInput;
use crate::implementations::mad_build::search_replace::SearchReplaceInput;
use crate::implementations::mad_build::todo::TodoWriteInput;
use crate::implementations::mad_build::update_goal::UpdateGoalInput;
use crate::implementations::mad_build::video_gen::{ImageToVideoInput, ReferenceToVideoInput};
use crate::implementations::mad_build::web_fetch::WebFetchInput;
use crate::implementations::mad_build::web_search::WebSearchInput;
...
pub enum ToolInput {
    ...
    HashlineEdit(crate::implementations::mad_build_hashline::edit::types::HashlineEditInput),
    ...
    Lsp(LspToolInput),
    Monitor(crate::implementations::mad_build::monitor::types::MonitorInput),
    SchedulerCreate(crate::implementations::mad_build::scheduler::create::SchedulerCreateInput),
    SchedulerDelete(crate::implementations::mad_build::scheduler::delete::SchedulerDeleteInput),
    SchedulerList(crate::implementations::mad_build::scheduler::list::SchedulerListInput),
    UpdateGoal(UpdateGoalInput),
    Workflow(crate::implementations::mad_build::workflow::WorkflowToolInput),
