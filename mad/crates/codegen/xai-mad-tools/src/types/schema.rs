...
///
/// Use with `#[schemars(with = "MadIntegerSchema")]` on `Option<usize>` fields.
pub struct MadIntegerSchema;
impl schemars::JsonSchema for MadIntegerSchema {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "mad_integer_schema".into()
    }
