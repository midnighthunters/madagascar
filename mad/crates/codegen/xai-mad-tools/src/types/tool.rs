...
///
/// Serializes to snake_case (`mad_build`, `mcp`, …) for the
...
/// (e.g. `"MadagascarBuild:read_file"`); only the serde form goes on the wire.
#[derive(
    Debug,
    Clone,
    Copy,
...
pub enum ToolNamespace {
    #[serde(alias = "MadagascarBuild")]
    MadagascarBuild,
    #[serde(alias = "MadagascarBuildConcise")]
    MadagascarBuildConcise,
    #[serde(alias = "MadagascarBuildHashline")]
    MadagascarBuildHashline,
    #[serde(alias = "Codex")]
    Codex,
