...
use crate::implementations::mad_build::task::types::SubagentCancelOutcome;
...
impl crate::types::tool_metadata::ToolMetadata for KillTaskTool {
    ...
    fn description_template(&self) -> &str {
        ...
        // fallback mirrors the default mad-build toolset on the current OS.
    ...
    fn requires_expr(&self) -> Expr<ToolRequirement> {
        ...
        let mut arms =
            crate::implementations::mad_build::task_output::background_bash_requires_exprs();
        arms.push(task_tool);
        Expr::Or(arms)
    }
}
