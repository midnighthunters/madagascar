...
pub const USER_AGENT_STRING: &str = "Mozilla/5.0 (compatible; mad-agent/1.0; +https://x.ai)";
...
pub struct WebFetchParams {
    ...
    /// allow_local = true` or `MAD_WEB_FETCH_ALLOW_LOCAL=1`.
    #[serde(default)]
    pub allow_local: Option<bool>,
}

register_resource!("mad_build", "WebFetch", WebFetchParams);
