...
const XAI_VIDEO_BASE_MODEL: &str = "mad-imagine-video";
const XAI_VIDEO_QUALITY_MODEL: &str = "mad-imagine-video-1.5-preview";
...
const DEFAULT_ZDR_VIDEO_KEY_PREFIX: &str = "mad-videos/";
...
pub struct VideoGenClient {
    ...
    /// and return the SuperMad upsell prose. See [`VideoGenClient::is_tier_restricted`].
...
impl VideoGenClient {
    ...
    /// SuperMad upsell instead of issuing a doomed request.
...
pub enum VideoGenConfig {
    ...
    Enabled {
        ...
        /// at call time with the SuperMad upsell prose. Set by the host from
...
/// the deliberate `/imagine-video` slash command shows the SuperMad upsell
/// modal instead.
pub(crate) const TIER_RESTRICTED_UPSELL: &str = "Video generation is a SuperMad feature and isn't available on the free or X Basic tier. Let the user know they can unlock image and video generation by upgrading to SuperMad: https://mad.com/supermad?referrer=mad-build. Do not retry this tool.";
