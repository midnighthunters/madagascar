...
use crate::implementations::mad_build::task::TaskTool;
use crate::implementations::mad_build::task::backend::SubagentBackendResource;
use crate::implementations::mad_build::task::types::{SubagentSnapshot, SubagentSnapshotStatus};
use crate::implementations::mad_build_concise::BashConciseTool;
...
/// `TaskOutput` cap. Env override: `MAD_MAX_WAIT_BLOCK_MS`.
const MAX_WAIT_BLOCK: Duration = Duration::from_secs(600);

fn max_wait_block() -> Duration {
    std::env::var("MAD_MAX_WAIT_BLOCK_MS")
        .ok()
...
pub(crate) fn background_bash_requires_exprs() -> Vec<Expr<ToolRequirement>> {
    ...
    let mad_build_bash = Expr::Value(ToolRequirement::Tool {
    ...
    let mad_build_concise_bash = Expr::Value(ToolRequirement::Tool {
    ...
    vec![mad_build_bash, mad_build_concise_bash, opencode_bash]
}
...
impl crate::types::tool_metadata::ToolMetadata for TaskOutputTool {
    ...
    fn description_template(&self) -> &str {
        ...
        // fallback mirrors the default mad-build toolset.
...
mod tests {
    ...
    fn tool_name_and_description() {
        ...
        // The static fallback is the shared builder's default mad-build
    ...
    fn resources_with_backend_query() -> (
        ...
        tokio::sync::mpsc::UnboundedReceiver<
            crate::implementations::mad_build::task::types::SubagentEvent,
        >,
    ) {
        use crate::implementations::mad_build::task::backend::{
            ChannelBackend, SubagentBackendResource,
        };
        use crate::implementations::mad_build::task::types::SubagentEvent;
    ...
    fn unwrap_query(
        event: crate::implementations::mad_build::task::types::SubagentEvent,
    ) -> crate::implementations::mad_build::task::types::SubagentQueryRequest {
        match event {
            crate::implementations::mad_build::task::types::SubagentEvent::Query(q) => q,
