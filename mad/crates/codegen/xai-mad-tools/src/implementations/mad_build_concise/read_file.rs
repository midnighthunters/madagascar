...
impl crate::types::tool_metadata::ToolMetadata for ReadFileConciseTool {
    ...
    fn tool_namespace(&self) -> ToolNamespace {
        ToolNamespace::MadagascarBuildConcise
    }
...
impl xai_tool_runtime::Tool for ReadFileConciseTool {
    ...
    async fn run(
        ...
        // MadagascarBuildConcise is not version-managed — always pass None.
...
mod tests {
    ...
    use crate::implementations::mad_build::read_file::ReadFileTool;
