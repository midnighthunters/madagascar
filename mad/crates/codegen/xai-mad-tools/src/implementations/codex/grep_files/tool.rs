...
use crate::implementations::mad_build::grep::ripgrep::rg_path;
...
///
/// Shares `ToolKind::Search` with the mad-build `GrepTool`. These tools are
/// namespace-exclusive — consumers enable either `MadagascarBuild` or `Codex` search,
