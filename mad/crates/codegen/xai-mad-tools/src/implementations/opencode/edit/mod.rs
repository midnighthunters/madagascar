...
use crate::implementations::mad_build::search_replace::CONTEXT_LINES;
use crate::implementations::mad_build::search_replace::helpers::{
...
// the snake_case `params.edit.old_string` keys of the mad_build twin resolve
...
// are imported from `mad_build::search_replace::helpers` — shared across
// both the mad_build and opencode edit tools.
