...
//! `MAD_SCROLL_LOG` pointed at a tempfile, then validates the pager's
//! flight-recorder JSONL (producer:
//! `xai-mad-pager/src/input/scroll_log.rs`) against gesture invariants.
//!
...
//! producer-side twin lives in `xai-mad-pager/src/input/mouse/tests.rs`
