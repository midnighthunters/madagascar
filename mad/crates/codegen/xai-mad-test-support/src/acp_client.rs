//! ACP stdio clients for testing mad sessions end-to-end: the typed
//! [`MadStdioClient`] (`agent-client-protocol::ClientSideConnection` —
...
/// Spawn `mad agent stdio` with the sandbox's canonical hermetic environment.
...
/// Drives `mad agent stdio` with verbatim newline-delimited JSON-RPC lines.
///
/// Exists for wire shapes the typed [`MadStdioClient`] (`ClientSideConnection`,
