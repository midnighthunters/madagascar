//! # xai-mad-hooks
//!
//! Runtime hook system for Mad — file-based discovery, command execution,
//! and policy enforcement.
//!
//! ## Overview
//!
//! This crate provides a minimal hooks system for Mad. Hooks are discovered
//! from dedicated directories (`~/.mad/hooks/` and `<git-worktree-root>/.mad/hooks/`),
...
//!     Some(Path::new("/home/user/.mad/hooks")),
//!     Some(Path::new("/project/.mad/hooks")),
//! );
//!
//! for err in &errors {
