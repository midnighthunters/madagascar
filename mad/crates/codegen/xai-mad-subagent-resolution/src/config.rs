...
//! `xai_mad_shell::config::{SubagentRole, SubagentPersona, PersonaIOField}`.
//!
//! Methods that remain in `xai-mad-shell` (on `SubagentsConfig`):
...
"#;
        ...
        assert_eq!(persona.model.as_deref(), Some("mad-3-fast"));
