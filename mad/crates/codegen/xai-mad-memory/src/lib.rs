...
//! Mad to persist important information across sessions. Memory files are
//! stored under `~/.mad/memory/` with workspace-scoped subdirectories
...
//! `MAD_MEMORY=1` environment variable. When disabled, this crate
