...
//!
//! The canonical types now live in `xai_mad_sampling_types::conversation`.
//! This module re-exports them and adds mad-shell-specific types
//! (`ConversationRequestTrace`) that depend on internal crate types.

// Re-export everything from the standalone crate.
pub use xai_mad_sampling_types::conversation::*;

// ============================================================================
// mad-shell-specific types (depend on internal crate types)
// ============================================================================

/// Tracing context for conversation requests.
///
/// Stays in `xai-mad-shell` because it references
...
// via `Box::new(trace)`.
//
// Tests for conversation types now live in xai-mad-sampling-types crate.
