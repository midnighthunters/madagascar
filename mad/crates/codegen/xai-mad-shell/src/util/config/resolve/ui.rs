...
pub const ENV_SHOW_THINKING_BLOCKS: &str = "MAD_SHOW_THINKING_BLOCKS";
...
///
/// Precedence: requirements > env (`MAD_SHOW_THINKING_BLOCKS`) >
...
pub const ENV_GROUP_TOOL_VERBS: &str = "MAD_GROUP_TOOL_VERBS";
...
///
/// Precedence: requirements > env (`MAD_GROUP_TOOL_VERBS`) >
...
pub const ENV_COLLAPSED_EDIT_BLOCKS: &str = "MAD_COLLAPSED_EDIT_BLOCKS";
...
///
/// Precedence: requirements > env (`MAD_COLLAPSED_EDIT_BLOCKS`) >
...
///
/// Precedence: `MAD_MOUSE_REPORTING_TOGGLE` env > `[ui] mouse_reporting_toggle`
...
pub fn resolve_mouse_reporting_toggle(
    ...
    BoolFlag::env("MAD_MOUSE_REPORTING_TOGGLE")
...
mod tests {
    ...
    // Assumes MAD_MOUSE_REPORTING_TOGGLE is unset in the test env.
    #[test]
