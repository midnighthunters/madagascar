...
pub const ENV_DISPLAY_REFRESH_PROBE_ENABLED: &str = "MAD_DISPLAY_REFRESH_PROBE_ENABLED";
pub const ENV_DISPLAY_REFRESH_AUTO_CADENCE: &str = "MAD_DISPLAY_REFRESH_AUTO_CADENCE";
...
/// Same band as env cadence knobs (`MAD_MIN_DRAW_MS` / `MAD_SCROLL_CADENCE_MS`).
