...
pub fn loaded_plugin_to_info(plugin: &xai_mad_agent::plugins::LoadedPlugin) -> PluginInfo {
    use xai_mad_agent::plugins::discovery::PluginScope as AgentScope;
...
fn origin_to_dto(origin: &xai_mad_agent::plugins::PluginOrigin) -> PluginOrigin {
    use xai_mad_agent::plugins::PluginOrigin as AgentOrigin;
    match origin {
        AgentOrigin::CliOverride => PluginOrigin::CliOverride,
        AgentOrigin::ProjectMad => PluginOrigin::ProjectMad,
        AgentOrigin::ProjectClaude => PluginOrigin::ProjectClaude,
        AgentOrigin::UserMad => PluginOrigin::UserMad,
...
mod tests {
    use super::*;
    use xai_mad_agent::plugins::PluginOrigin as AgentOrigin;
    use xai_mad_agent::plugins::discovery::{PluginId, PluginScope as AgentScope};

    fn make_loaded_plugin(origin: AgentOrigin) -> xai_mad_agent::plugins::LoadedPlugin {
        let root = std::path::PathBuf::from("/tmp/test-plugin");
        xai_mad_agent::plugins::LoadedPlugin {
