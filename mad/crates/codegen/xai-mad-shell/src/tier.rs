...
//! (SuperMad, SuperMad Heavy/Lite, X Premium/+, and any unknown future name)
...
mod tests {
    ...
    fn unrestricted_names() {
        assert!(!is_restricted_tier_name("SuperMad"));
        assert!(!is_restricted_tier_name("SuperMad Heavy"));
        assert!(!is_restricted_tier_name("supermad_lite"));
