//! Todo types — re-exported from `xai-mad-tools` with ACP conversion helpers.
//!
//! Types are canonical in `xai-mad-tools`. This module adds ACP ↔ TodoItem
//! conversions since `xai-mad-tools` is protocol-agnostic.

pub use xai_mad_tools::implementations::mad_build::todo::TodoId;
pub use xai_mad_tools::implementations::mad_build::todo::TodoItem;
pub use xai_mad_tools::implementations::mad_build::todo::TodoPriority;
pub use xai_mad_tools::implementations::mad_build::todo::TodoState;
pub use xai_mad_tools::implementations::mad_build::todo::TodoStatus;
