...
pub(crate) fn ctx_with_toggle(toggle: HashMap<String, bool>) -> SubagentSpawnContext {
    ...
    SubagentSpawnContext {
        ...
        fs: Arc::new(xai_mad_workspace::file_system::LocalFs::new(
            PathBuf::from("/tmp"),
        )),
        ...
        auth_manager: Arc::new(crate::auth::AuthManager::new(
            std::path::Path::new("/tmp/nonexistent-mad-test"),
        ...
        parent_skills: None,
        parent_skills_config: xai_mad_agent::prompt::skills::SkillsConfig::default(),
        parent_compat: xai_mad_tools::types::compat::CompatConfig::default(),
        task_completion_reservations: None,
        synthetic_trace_tx: None,
        task_output_tool_name: xai_mad_tools::reminders::task_completion::DEFAULT_TASK_OUTPUT_TOOL
            .to_string(),
...
impl xai_mad_tools::implementations::lsp::LspBackend for DummyLspDispatch {
    ...
    async fn dispatch(
        &self,
        _input: &xai_mad_tools::implementations::lsp::LspToolInput,
    ) -> xai_mad_tools::implementations::lsp::LspToolResult {
        xai_mad_tools::implementations::lsp::LspToolResult {
            text: String::new(),
            is_error: false,
        }
    ...
    ) -> Option<xai_mad_tools::implementations::lsp::DiagnosticsSummary> {
        None
    }
    ...
    ) -> Vec<xai_mad_tools::implementations::lsp::FileDiagnosticEntry> {
        vec![]
    }
}
