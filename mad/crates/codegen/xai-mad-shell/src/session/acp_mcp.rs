...
//!
//! The official `mad-agent-sdk` lets a host define in-process tools (`@tool` /
...
use xai_mad_mcp::acp_transport::AcpReverseInvoker;
use xai_mad_mcp::servers::AcpServerEntry;
