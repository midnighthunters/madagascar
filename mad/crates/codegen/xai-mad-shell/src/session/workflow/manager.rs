...
impl WorkflowManager {
    ...
    fn cancel_children_for_run(&self, run_id: &str) -> bool {
        ...
        self.subagent_event_tx
            .send(
                xai_mad_tools::implementations::mad_build::task::types::SubagentEvent::Cancel(
                    xai_mad_tools::implementations::mad_build::task::types::SubagentCancelRequest {
                        parent_session_id: Some(self.session_id.clone()),
                        target: xai_mad_tools::implementations::mad_build::task::types::SubagentCancelTarget::WorkflowRunId(
                            run_id.to_owned(),
                        ),
                        respond_to,
                    },
...
mod tests {
    ...
    type CancelLog = Arc<
        parking_lot::Mutex<
            Vec<xai_mad_tools::implementations::mad_build::task::types::SubagentCancelTarget>,
        >,
    >;
    ...
    async fn pause_marks_user_paused_and_resume_replays() {
        ...
        use xai_mad_tools::implementations::mad_build::task::types::SubagentEvent;
        ...
        use xai_mad_tools::implementations::mad_build::task::types::SubagentResult;
    ...
    async fn workflow_spawns_await_to_completion() {
        ...
        assert_eq!(
            ...
            xai_mad_tools::implementations::mad_build::task::types::ModelOverrideProvenance::Tool,
