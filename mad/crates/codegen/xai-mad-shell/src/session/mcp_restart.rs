...
//! window containing a [`xai_mad_mcp::servers::McpClientEventKind::TransportClosed`]
//! or [`xai_mad_mcp::servers::McpClientEventKind::HandshakeFailed`] key for a
...
//!    [`xai_mad_mcp::servers::start_mcp_server`] sets
...
//!    push and stop.
//! 5. **Already-Empty** — see the [`xai_mad_mcp::servers::ClientStateKind::Empty`]
...
use xai_mad_mcp::servers::{McpClientEventKind, McpServerName};
