...
//! shell-specific types (`xai_mad_tools::MemoryBackend`, memory context).
//!
...
//! [`xai_mad_compaction::reminder`] so mad-chat and mad-build stay in lockstep.
...
use xai_mad_compaction::reminder::{
...
pub fn to_system_reminder_sync(
    ...
    skills: &[xai_mad_tools::implementations::skills::types::SkillInfo],
...
pub async fn to_system_reminder(
    ...
    discovered_agents_md: &[PathBuf],
    skills: &[xai_mad_tools::implementations::skills::types::SkillInfo],
    memory_backend: Option<&dyn xai_mad_tools::types::memory_backend::MemoryBackend>,
    subagent_tool_names: Option<&SubagentToolNames>,
    mcp_tool_names: Option<&McpToolNames>,
) -> Option<String> {
...
fn to_system_reminder_inner(
    ...
    discovered_agents_md: &[PathBuf],
    skills: &[xai_mad_tools::implementations::skills::types::SkillInfo],
    memory_results: &[xai_mad_tools::types::memory_backend::MemorySearchResult],
    subagent_tool_names: Option<&SubagentToolNames>,
    mcp_tool_names: Option<&McpToolNames>,
) -> Option<String> {
    ...
    if let Some(listing) =
        xai_mad_tools::types::skill_discovery_tracker::format_compaction_skill_listing(skills)
    {
    ...
    if !ctx.connected_mcp_servers.is_empty() {
        use xai_mad_tools::implementations::search_tool::format_compaction_server_line;
