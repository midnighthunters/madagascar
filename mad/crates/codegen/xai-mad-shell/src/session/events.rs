...
) -> Option<xai_mad_sampling_types::PriorTurnInterrupt> {
    use xai_mad_sampling_types::PriorTurnInterrupt;
    match category {
...
/// committing it would silently run mad-build flavor. Distinct from
