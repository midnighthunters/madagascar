...
use xai_mad_tools::implementations::mad_build::exit_plan_mode::ExitPlanModeExtRequest;
...
async fn seeded_active_plan_actor_with_edit_tools() -> (
    ...
    *actor.agent.borrow_mut() = test_agent_with_tools(vec![
        ToolConfig::from_id("MadagascarBuild:read_file"),
        ToolConfig {
            id: "MadagascarBuild:search_replace".into(),
            params: Some(
    ...
    actor
        ...
        .borrow()
        .tool_bridge()
        .update_resource(xai_mad_tools::types::resources::PlanFilePath(
            plan_path.clone(),
        ))
        .await;
...
async fn mixed_permission_cancel_skips_exit_reverse_request() {
    ...
    local
        .run_until(async {
            ...
            use xai_mad_tools::implementations::mad_build::exit_plan_mode::ExitPlanModeTool;
            use xai_mad_tools::registry::types::ToolConfig;
            use xai_mad_workspace::permission::{ClientType, spawn_permission_manager};
            ...
            *actor.agent.borrow_mut() = test_agent_with_tools(vec![
                ToolConfig {
                    id: "MadagascarBuild:run_terminal_cmd".into(),
                    params: Some(
                        serde_json::from_value(serde_json::json!({
