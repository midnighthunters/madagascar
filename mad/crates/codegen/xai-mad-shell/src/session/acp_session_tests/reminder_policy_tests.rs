...
use xai_mad_agent::prompt::context::{PromptAudience, TemplateOverride};
use xai_mad_agent::system_reminder::{
    ...
    local
        .run_until(async {
            ...
            *actor.agent.borrow_mut() = test_agent_with_user_message_template(
                xai_mad_agent::prompt::user_message::UserMessageTemplate::Custom(
