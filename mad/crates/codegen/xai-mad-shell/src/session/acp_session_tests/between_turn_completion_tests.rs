use xai_mad_tools::implementations::mad_build::task::types::SubagentCompletionSummary;
use xai_mad_tools::reminders::task_completion::format_between_turn_completions;
