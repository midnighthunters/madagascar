...
pub(crate) enum SamplerTurnOutcome {
    ...
    Response(
        ...
        Box<xai_mad_sampler::InferenceLatencyStats>,
    ),
    CompactAndResubmit,
...
pub(crate) enum DrainSource {
    Pending(xai_mad_tools::implementations::mad_build::update_goal::UpdateGoalInput),
    Channel(xai_mad_tools::implementations::mad_build::update_goal::UpdateGoalEnvelope),
}
