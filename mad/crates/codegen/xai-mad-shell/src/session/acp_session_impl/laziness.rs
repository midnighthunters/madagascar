...
impl SessionActor {
    ...
    /// sees "Mad is thinking", streaming token chunks, or any other
    ...
    pub(crate) async fn maybe_fire_laziness_check(self: Arc<Self>) {
        ...
        let items = vec![
            ConversationItem::System(xai_mad_sampling_types::SystemItem {
        ...
        let request = ConversationRequest {
            ...
            // Don't pass `reasoning_effort` — `mad-4.5` (and
            // other tool-flavoured Mad variants) reject the field at
            ...
            x_mad_session_id: Some(session_id_str),
