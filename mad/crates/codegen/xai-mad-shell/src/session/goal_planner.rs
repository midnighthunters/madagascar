...
///
/// [`SubagentRuntimeOverrides::harness_agent_type`]: xai_mad_tools::implementations::mad_build::task::types::SubagentRuntimeOverrides::harness_agent_type
...
pub(crate) struct RoleSpawnOverride {
    ...
    /// Resolved harness `agent_type` (e.g. `"mad-build-plan"`)
...
mod tests {
    ...
    fn planner_template_default_render_preserves_wording_and_has_no_placeholders() {
        ...
        // (mad-build) tool names; guards against accidental wording drift.
