...
use super::super::MadAuth;
use super::protocol::{OidcError, OidcUserInfo, build_mad_auth, discover, refresh_tokens};
...
pub(crate) async fn oidc_token_exchange(auth: &MadAuth) -> OidcRefreshResult {
    ...
    let mut new_auth = build_mad_auth(tokens, user_info, issuer, client_id);
