...
impl TokenType {
    ...
    pub(crate) fn from_auth(auth: Option<&MadAuth>) -> Self {
        match auth {
            None => Self::None,
    ...
    pub(crate) fn telemetry_kind(self) -> xai_mad_telemetry::events::AuthTokenKind {
        use xai_mad_telemetry::events::AuthTokenKind as K;
        match self {
