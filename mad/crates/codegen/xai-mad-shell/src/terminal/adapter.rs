//! `AcpTerminalAdapter`: implements `xai-mad-tools::TerminalBackend` over ACP
...
use xai_mad_tools::computer::types::{
...
/// Wraps xai-mad-shell's ACP gateway to satisfy xai-mad-tools' TerminalBackend.
