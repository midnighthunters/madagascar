...
//
// State is persisted to `~/.mad/claude_import_state.json`.
...
use xai_mad_workspace::permission::claude_settings::find_claude_settings_paths;

// Types

/// Persistent import state, loaded from / saved to `~/.mad/claude_import_state.json`.
...
fn state_path() -> PathBuf {
    crate::util::mad_home::mad_home().join("claude_import_state.json")
}
