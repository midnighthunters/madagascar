//! Shared helpers for xai-mad-shell integration tests.

use xai_mad_shell::sampling::{ApiBackend, Client, SamplerConfig};
...
pub mod leader {
    ...
    use xai_mad_test_support::leader::{LeaderFixture, LeaderStdioClient};
...
pub fn test_sampler_config(
    ...
    // Shell `Client` is `xai_mad_sampler::SamplingClient`, which takes a
