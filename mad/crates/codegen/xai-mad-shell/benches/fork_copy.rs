...
//!
//! Run: `cargo bench -p xai-mad-shell --bench fork_copy`
...
use xai_mad_shell::session::storage::{CopySessionOptions, JsonlStorageAdapter, StorageAdapter};
use xai_mad_shell::session::testkit::synth::synthesize_to_target_bytes;
