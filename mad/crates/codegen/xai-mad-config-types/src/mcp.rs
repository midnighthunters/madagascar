//! MCP server configuration value types, extracted from xai-mad-shell
...
use xai_mad_mcp::oauth_config::McpOAuthConfig;
...
/// and surfaced through `mad inspect`.
...
impl RelaySyncConfig {
    ...
    pub fn is_enabled(&self) -> bool {
        if let Ok(env_val) = std::env::var("MAD_RELAY_SYNC_ENABLED") {
