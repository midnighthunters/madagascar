//! Installed mad CLI version, lockstepped with shipping binaries.

use semver::Version;

pub const TEST_VERSION_ENV: &str = "MAD_TEST_VERSION";

pub const VERSION: &str = match option_env!("MAD_VERSION") {
    Some(v) => v,
