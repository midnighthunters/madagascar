#!/bin/bash
#
# Madagascar CLI installer (enterprise channel) — https://x.ai/cli/enterprise-install.sh
#
...
#   MAD_DEPLOYMENT_KEY=<key> bash <(curl -fsSL https://x.ai/cli/enterprise-install.sh)
#
