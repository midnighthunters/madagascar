...
async fn storage_upload_parks_on_401_and_drains_after_recovery() {
    ...
    let overrides = [
        ...
        EnvOp::set("MAD_TRACE_UPLOAD", "true"),
        EnvOp::set("MAD_TELEMETRY_TRACE_UPLOAD", "true"),
        EnvOp::set("MAD_UPLOAD_QUEUE_AUTH_PROBE_SECS", "2"),
    ];
    ...
    //   not fire inside this 3s window; with `MAD_UPLOAD_QUEUE_AUTH_PROBE_SECS=2`
