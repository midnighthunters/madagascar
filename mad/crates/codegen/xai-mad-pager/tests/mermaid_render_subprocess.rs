...
use xai_mad_pager::app::mermaid_worker::render_via_subprocess;
use xai_mad_pager::scrollback::blocks::mermaid_content::MermaidRenderQuality;
...
fn tight_timeout_kills_child_and_returns_err() {
    ...
    // `xai_mad_mermaid::subprocess` `reap_terminates_the_process` unit test;
