...
Terminal UI (TUI) for Madagascar Build. Provides the interactive full-screen interface
...
- [Hook Examples](../xai-mad-hooks/examples/README.md) — sample hooks for common workflows
- [Hooks Crate (`xai-mad-hooks`)](../xai-mad-hooks/) — hook runtime, event types, and execution engine
- [Plugin Marketplace Crate (`xai-mad-plugin-marketplace`)](../xai-mad-plugin-marketplace/) — marketplace source loading, scanning, and install
