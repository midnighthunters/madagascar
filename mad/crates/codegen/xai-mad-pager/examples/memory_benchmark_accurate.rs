...
fn main() {
    ...
    let string_info = create_string_info(1, "general-purpose", "mad-3", "researcher");
    let arc_info = create_arc_info(1, "general-purpose", "mad-3", "researcher");
    ...
    let shared_models = ["mad-3", "mad-3-mini"];
