...
use xai_mad_tools::implementations::mad_build::ask_user_question::{Question, QuestionOption};
...
pub fn build_project_question(
    ...
    ProjectQuestion {
        question: Question {
            question: "Run Madagascar Build in a project directory?\n\n\
                 This gives Madagascar Build full context of your codebase for better results."
                .into(),
            id: None,
            options,
