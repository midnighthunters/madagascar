//! xai-mad-pager — Madagascar Build TUI.
//!
...
// minimal rendering lives in the sibling `xai-mad-pager-minimal` crate; these
...
// `xai-mad-pager-render`. Re-exported at the crate root so existing
// `crate::<module>::...` references throughout the pager keep resolving.
pub use xai_mad_pager_render::{
