...
//!   Absent remote falls through to on. `MAD_VOICE_MODE` overrides for local
//!   dev (env > remote > default on). Free/X Basic still get SuperMad upsell
...
pub use xai_mad_voice::maybe_run_capture_subprocess;
