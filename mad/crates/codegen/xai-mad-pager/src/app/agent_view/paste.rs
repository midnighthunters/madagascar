...
pub(super) mod paste_key_tests {
    ...
    -> crate::views::question_view::QuestionViewState {
        let question = xai_mad_tools::implementations::mad_build::ask_user_question::Question {
            question: "Pick one?".to_string(),
            options: vec![
                xai_mad_tools::implementations::mad_build::ask_user_question::QuestionOption {
                    label: "A".to_string(),
