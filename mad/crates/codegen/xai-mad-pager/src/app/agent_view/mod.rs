...
pub struct BannerSlotParams<'a> {
    ...
    pub(crate) announcements: &'a [xai_mad_announcements::RemoteAnnouncement],
...
pub struct AgentView {
    ...
    pub context_state: Option<xai_mad_shell::session::ContextInfo>,
    ...
    pub(crate) deferred_session_mode: Option<xai_mad_tools::types::SessionMode>,
    ...
    match kind {
        ...
        LocalQuestionKind::CreditLimitUpsell { choices } => {
            ...
            let choice = choices
                .get(*idx)
                .copied()
                .unwrap_or(xai_mad_telemetry::events::CreditLimitChoice::PayAsYouGo);
            xai_mad_telemetry::session_ctx::log_event(
                xai_mad_telemetry::events::CreditLimitUpsellClicked {
        ...
        LocalQuestionKind::FreeUsageUpsell { source } => {
            ...
            xai_mad_telemetry::session_ctx::log_event(
                xai_mad_telemetry::events::SuperMadUpsellClicked {
                    source,
                    auth_method: None,
                },
            );
...
fn translate_project_select(
    ...
    use xai_mad_telemetry::events::{ProjectPickerOutcome, ProjectPickerSelected};
    let project_dir_options = resolved_paths.len().saturating_sub(1);
    let emit = |outcome: ProjectPickerOutcome| {
        xai_mad_telemetry::session_ctx::log_event(ProjectPickerSelected {
            outcome,
...
fn remember_mode_enabled() -> bool {
    let path = xai_mad_tools::util::mad_home::mad_home().join("config.toml");
...
fn question_visible_h(
    ...
    prompt_height: u16,
    question: &xai_mad_tools::implementations::mad_build::ask_user_question::Question,
    content_w: usize,
    preview: Option<&str>,
    fullscreen: bool,
    desc_cap: u16,
