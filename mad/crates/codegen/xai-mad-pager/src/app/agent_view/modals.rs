...
impl AgentView {
    ...
    fn log_extensions_modal_action(
        &self,
        action: &str,
        input_method: xai_mad_telemetry::events::ExtensionsInputMethod,
    ) {
    ...
    fn log_extensions_modal_action_with(
        ...
        if let Some(ref state) = self.extensions_modal {
            xai_mad_telemetry::session_ctx::log_event(
                xai_mad_telemetry::events::ExtensionsModalAction {
    ...
    pub(super) fn handle_extensions_modal_key(
        ...
        // Ctrl+O opens mad.com connectors on the MCP servers tab.
            ...
            })
        {
            self.log_extensions_modal_action(
                "open_connectors",
                xai_mad_telemetry::events::ExtensionsInputMethod::Keyboard,
            );
        ...
        if let Some(ch) = chrome_shortcut_ch {
                ...
                .and_then(|s| crate::views::extensions_modal::resolve_key(s.active_tab, ch))
            {
                self.log_extensions_modal_resolved_action(
                    ch,
                    &action,
                    xai_mad_telemetry::events::ExtensionsInputMethod::Mouse,
                );
...
mod extensions_action_target_tests {
    ...
    fn skills_toggle_resolves_name_and_resulting_state() {
        let skill = xai_mad_tools::implementations::skills::types::SkillInfo {
            name: "my-skill".into(),
            enabled: false,
            ..Default::default()
        };
