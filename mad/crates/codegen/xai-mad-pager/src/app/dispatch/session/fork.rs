...
-> [xai_mad_tools::implementations::mad_build::ask_user_question::QuestionOption; 2] {
    use xai_mad_tools::implementations::mad_build::ask_user_question::QuestionOption;
    [
        QuestionOption {
