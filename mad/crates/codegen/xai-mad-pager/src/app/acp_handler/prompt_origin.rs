...
pub(crate) fn is_server_initiated_prompt(prompt_id: &str) -> bool {
    xai_mad_shell::session::PromptOrigin::from_prompt_id(prompt_id).is_synthetic()
}
...
pub(crate) fn is_scheduler_fired_prompt(prompt_id: &str) -> bool {
    matches!(
        xai_mad_shell::session::PromptOrigin::from_prompt_id(prompt_id),
        xai_mad_shell::session::PromptOrigin::SchedulerFired
    )
}
...
pub(crate) fn is_wake_prompt(prompt_id: &str) -> bool {
    matches!(
        xai_mad_shell::session::PromptOrigin::from_prompt_id(prompt_id),
        xai_mad_shell::session::PromptOrigin::TaskCompleted { .. }
            | xai_mad_shell::session::PromptOrigin::SubagentCompleted { .. }
            | xai_mad_shell::session::PromptOrigin::WorkflowCompleted { .. }
            | xai_mad_shell::session::PromptOrigin::NotificationDrain
    )
}
