...
const HERO_SUBTITLE: &str = "Thanks for trying Madagascar Build, give feedback with /feedback!";
...
pub(super) fn compute_hero_box(
    ...
    announcement: Option<&xai_mad_announcements::RemoteAnnouncement>,
    expanded: bool,
...
managed devices and accounts. Report security incidents";
    ...
    fn upgrade_cta_reserves_rows_and_returns_button_rect() {
        ...
        let a = ann(None, Some("Mad 4.5 is here. Upgrade now."));
        ...
        let mut pinned = ann(None, Some("Mad 4.5 is here. Upgrade now."));
        pinned.dismissible = Some(false);
        pinned.cta = Some(xai_mad_announcements::AnnouncementCta {
            label: Some("Upgrade Account".into()),
            url: Some("https://x.ai/mad".into()),
        ...
        let mut dismissible = ann(None, Some("Mad 4.5 is here. Upgrade now."));
        dismissible.cta = Some(xai_mad_announcements::AnnouncementCta {
            label: Some("Upgrade Account".into()),
            url: Some("https://x.ai/mad".into()),
            caption: Some("or use Ctrl+O".into()),
        });
