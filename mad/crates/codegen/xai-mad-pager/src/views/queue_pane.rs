...
pub struct QueuePane {
    ...
    /// `bg_highlight` — e.g. MadNight's dark band leaking into MadDay).
...
impl QueuePane {
    ...
    pub fn render(
        ...
        // at construction (default MadNight, dark) after the user switches —
        // painting a dark band on a light MadDay canvas.
