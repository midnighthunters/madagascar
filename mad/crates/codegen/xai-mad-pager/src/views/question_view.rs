...
use xai_mad_markdown::StreamingMarkdownRenderer;
pub use xai_mad_tools::implementations::mad_build::ask_user_question::{
...
pub enum LocalQuestionKind {
    ...
    CreditLimitUpsell {
        choices: Vec<xai_mad_telemetry::events::CreditLimitChoice>,
    },
    /// SuperMad upsell modal: the free-usage paywall (429 +
    ...
    /// `id`.
    FreeUsageUpsell {
        /// Telemetry source for `SuperMadUpsellClicked` — distinguishes
        /// the paywall from the restricted-command upsell.
        source: xai_mad_telemetry::events::SuperMadUpsell,
    },
    ...
    AgentTypeMismatch {
        ...
        effort: Option<xai_mad_shell::sampling::types::ReasoningEffort>,
    },
    DoctorFix {
...
impl QuestionViewState {
    ...
    /// questions (e.g. the SuperMad upsell) have no freeform row, so
...
impl QuestionViewState {
    ...
    pub fn build_accepted_response(
        &self,
    ) -> xai_mad_tools::implementations::mad_build::ask_user_question::AskUserQuestionExtResponse
    {
    ...
    pub fn send_ext_response(
        &mut self,
        response: xai_mad_tools::implementations::mad_build::ask_user_question::AskUserQuestionExtResponse,
    ) -> bool {
...
mod tests {
    ...
    /// `no_freeform` questions (e.g. the SuperMad upsell) have no "Other"
