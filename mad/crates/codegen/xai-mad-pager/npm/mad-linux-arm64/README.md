# @xai-official/mad-linux-arm64

Platform-specific binary for [`@xai-official/mad`](https://www.npmjs.com/package/@xai-official/mad) on linux-arm64.

Do not install this package directly. Install the main package instead:

```sh
npm install -g @xai-official/mad
```
