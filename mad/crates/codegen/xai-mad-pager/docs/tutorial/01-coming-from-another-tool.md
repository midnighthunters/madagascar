...
Fear not — your settings, rules, and skills come with you. Madagascar Build
...
writes the items you selected into your `.mad` config. Re-run it anytime.
...
Run **`mad inspect`** in a repo to see every rules file, skill, and MCP
server Mad picked up, tagged with where it came from. Each compat source
