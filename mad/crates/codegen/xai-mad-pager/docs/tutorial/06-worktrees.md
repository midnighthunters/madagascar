...
Want Mad working on a feature while you (or another Mad session) work on
...
- **From the shell:**
  ...
  ```bash
  mad --worktree=my-feature "refactor the auth module"
  ```
...
- Run two or three Mad sessions on the same repo simultaneously.
