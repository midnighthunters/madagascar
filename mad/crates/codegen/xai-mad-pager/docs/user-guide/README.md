# Madagascar Build User Guide

Learn how to install, configure, and extend Madagascar Build, the terminal-based AI coding assistant from SpaceXAI.
...
Customize and extend Madagascar Build.
...
Automate, script, and integrate Madagascar Build with other systems.

| # | Document | Description |
|---|----------|-------------|
| 14 | [Headless Mode and Scripting](14-headless-mode.md) | `mad -p`, output formats, CI/CD integration, and piping |
