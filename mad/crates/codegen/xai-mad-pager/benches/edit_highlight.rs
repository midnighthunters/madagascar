...
//!
//! ```text
//! cargo bench -p xai-mad-pager --bench edit_highlight
//! cargo bench -p xai-mad-pager --bench edit_highlight -- edit_hl/upgrade
//! ```
...
use xai_mad_pager::diff::{DiffHunk, DiffLine};
use xai_mad_pager::scrollback::blocks::tool::{
...
use xai_mad_pager::syntax::{Syntect, get_syntect};
