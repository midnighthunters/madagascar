//! Criterion benchmarks for the xai-mad-pager rendering pipeline.
//!
...
use xai_mad_pager::scrollback::render::render_scrolled_entries_with_scratch;
use xai_mad_pager::scrollback::wrappers::EntryRenderer;
use xai_mad_pager::scrollback::{
