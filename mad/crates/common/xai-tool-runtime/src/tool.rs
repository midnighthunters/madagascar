...
/// `filename`, `path`, `metadata`) that the Mad SLOP converter uses to
...
pub enum ContentBlock {
    ...
    ///
    /// Optional metadata fields are used by the Mad SLOP converter to
    ...
    /// - `path`: file path on the Mad Computer filesystem
