//! Compacted-history assembly (mad-build's rebuild structure, generic).
//!
...
//! ```
//!
//! mad-build is the canonical harness. The summary carrier text is built by
...
pub fn assemble_compacted_history<T: CompactionItemFactory>(
    ...
    // mad-build keeps the legacy `<user_query>`-wrapped continuation text and
...
mod tests {
    ...
    #[test]
    fn mad_build_order_recent_before_summary() {
