...
//! string/text manipulation. Harness-bound extraction (Mad chat's
//! `MadConversation` traversal, `ChatCompletionRequest` user-message
//! extraction, `MadMessage` assembly) stays in the harness crate.
