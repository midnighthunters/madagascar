...
//!
//! These types support the feedback collection system for Mad sessions.
//! The agent (xai-mad-shell) uses heuristics to determine when to request feedback,
...
fn default_tier1_prompt() -> String {
    "You've been using Mad Code productively! Would you mind sharing quick feedback?".to_string()
}
