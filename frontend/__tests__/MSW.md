...
> [!NOTE]
> **Madagascar vs SaaS Mode**
>
> Madagascar runs in two modes:
> - **Madagascar mode**: For local/self-hosted deployments where users provide their own LLM API keys and configure git providers manually
