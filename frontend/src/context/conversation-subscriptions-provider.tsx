...
import { MadagascarParsedEvent } from "#/types/core";
import {
  isMadagascarEvent,
...
interface ConversationSubscriptionsContextType {
  ...
  getEventsForConversation: (conversationId: string) => MadagascarParsedEvent[];
}
...
const isAgentStatusError = (event: unknown): event is MadagascarParsedEvent =>
  isMadagascarEvent(event) &&
