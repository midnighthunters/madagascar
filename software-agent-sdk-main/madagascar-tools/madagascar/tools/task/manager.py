...
from madagascar.sdk.security import ConfirmationPolicyBase
from madagascar.sdk.subagent.registry import AgentFactory, get_agent_factory
        ...
        if self._parent_conversation is None:
            ...
            if parent_persistence_dir is not None:
                ...
                self._persistence_dir = Path(
                    tempfile.mkdtemp(prefix="madagascar_tasks_")
                )
