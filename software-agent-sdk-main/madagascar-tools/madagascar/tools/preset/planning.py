...
def register_planning_tools() -> None:
    ...
    from madagascar.tools.glob import GlobTool  # noqa: F401
    from madagascar.tools.grep import GrepTool  # noqa: F401
    from madagascar.tools.planning_file_editor import (
