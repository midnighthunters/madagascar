...
Usage:
    ...
    ```python
    from madagascar.tools.gemini import (
...
from madagascar.sdk import Tool
from madagascar.tools.gemini.edit import EditAction, EditObservation, EditTool
from madagascar.tools.gemini.list_directory import (
    ListDirectoryAction,
    ListDirectoryObservation,
    ListDirectoryTool,
)
from madagascar.tools.gemini.read_file import (
    ReadFileAction,
    ReadFileObservation,
    ReadFileTool,
)
from madagascar.tools.gemini.write_file import (
    WriteFileAction,
