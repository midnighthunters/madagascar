"""Build the default :class:`~madagascar.sdk.profiles.AgentProfile` from live settings.

The inverse of :func:`~madagascar.sdk.profiles.resolve_agent_profile`: turns the
...
if TYPE_CHECKING:
    from madagascar.sdk.settings import AgentSettingsConfig
...
def build_seed_profile(
    ...
    *,
    ...
    ``mcp_server_refs=None`` exposes all of the user's MCP servers; an Madagascar
