...
class MadagascarModel(BaseModel):
    ...
    New code should extend pydantic.BaseModel directly instead of MadagascarModel.

    Existing code that extends MadagascarModel will continue to work, but
    migration to BaseModel is recommended.
    """


class DiscriminatedUnionMixin(MadagascarModel):
