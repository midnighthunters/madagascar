...
SETTINGS_METADATA_KEY = "madagascar_settings"
SETTINGS_SECTION_METADATA_KEY = "madagascar_settings_section"
...
class SettingsFieldMetadata(BaseModel):
    ...
    variant (``"madagascar"`` or ``"acp"``). Fields with ``variant=None`` are
