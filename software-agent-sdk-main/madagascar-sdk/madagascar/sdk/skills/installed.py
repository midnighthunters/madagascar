"""Installed skills management for Madagascar SDK.
...
from madagascar.sdk.skills.utils import find_skill_md
...
DEFAULT_INSTALLED_SKILLS_DIR = Path.home() / ".madagascar" / "skills" / "installed"
...
def install_skills_from_marketplace(
    ...
    from madagascar.sdk.plugin import resolve_source_path
