"""Skill management for Madagascar SDK.
...
- `load_user_skills` - Load skills from ~/.madagascar/skills/
- `load_public_skills` - Load skills from the public Madagascar extensions repo
...
# Fetch utilities
from madagascar.sdk.skills.fetch import SkillFetchError, fetch_skill_with_resolution

# Installed skills management
from madagascar.sdk.skills.installed import (
    InstalledSkillInfo,
    disable_skill,
    enable_skill,
    get_installed_skill,
...
# Types
from madagascar.sdk.skills.types import (
    InputMetadata,
