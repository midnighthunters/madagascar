...
Delegates to :mod:`madagascar.sdk.extensions.fetch` for the actual fetch logic
...
DEFAULT_CACHE_DIR = Path.home() / ".madagascar" / "cache" / "plugins"
...
def fetch_plugin(
    ...
    Args:
        ...
        cache_dir: Directory for caching. Defaults to ~/.madagascar/cache/plugins/
