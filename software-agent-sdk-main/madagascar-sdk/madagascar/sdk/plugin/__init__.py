"""Plugin module for Madagascar SDK.
...
user's home directory (~/.madagascar/plugins/installed/).

Note: Marketplace classes live in ``madagascar.sdk.marketplace``.
"""

from madagascar.sdk.plugin.discovery import (
    load_available_plugins,
    load_project_plugins,
    load_user_plugins,
)
from madagascar.sdk.plugin.fetch import (
    PluginFetchError,
...
from madagascar.sdk.plugin.loader import load_plugins
...
from madagascar.sdk.plugin.types import (
    CommandDefinition,
    PluginAuthor,
    PluginManifest,
    PluginSource,
