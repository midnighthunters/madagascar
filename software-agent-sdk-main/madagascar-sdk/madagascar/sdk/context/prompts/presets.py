...
omits the default Madagascar sections. The dynamic-tier sections are **shared** --
...
from madagascar.sdk.context.prompts.section import PromptSection
...
def create_registry(preset: PromptPreset = PromptPreset.DEFAULT) -> PromptRegistry:
    ...
    ``DEFAULT`` is the standard Madagascar composition; ``PLANNING`` is the read-only
