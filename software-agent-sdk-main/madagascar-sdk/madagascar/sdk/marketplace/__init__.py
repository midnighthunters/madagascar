"""Marketplace module for Madagascar SDK.
...
from madagascar.sdk.marketplace.registration import (
...
def __getattr__(name: str) -> Any:
    if name in _TYPE_EXPORTS:
        return getattr(import_module("madagascar.sdk.marketplace.types"), name)
    if name in _REGISTRY_EXPORTS:
        return getattr(import_module("madagascar.sdk.marketplace.registry"), name)
