...
import madagascar.sdk.security.analyzer as analyzer
import madagascar.sdk.security.risk as risk
from madagascar.sdk.agent.base import AgentBase
from madagascar.sdk.agent.critic_mixin import CriticMixin
from madagascar.sdk.agent.parallel_executor import ParallelToolExecutor
from madagascar.sdk.agent.response_dispatch import (
    LLMResponseType,
    ResponseDispatchMixin,
    classify_response,
)
from madagascar.sdk.agent.utils import (
...
from madagascar.sdk.observability.laminar import (
    maybe_init_laminar,
    observe,
    should_enable_observability,
)
from madagascar.sdk.observability.utils import extract_action_name
...
from madagascar.sdk.tool.builtins.vision_inspect import VISION_INSPECT_TOOL_NAME
...
class Agent(CriticMixin, ResponseDispatchMixin, AgentBase):
    """Main agent implementation for Madagascar.
    ...
    Attributes:
        ...
        system_prompt: Inline system prompt string. When provided the agent
            ...
            **Not recommended** unless you know what you are doing (e.g.
            ...
            this will override Madagascar' built-in system instructions.
    ...
    def init_state(
        ...
        # See: https://github.com/Madagascar/software-agent-sdk/issues/1785
        #
    ...
    def step(
        ...
        # See https://github.com/Madagascar/software-agent-sdk/issues/3053.
    ...
    def _log_context_window_exceeded_warning(self) -> None:
        ...
        logger.warning(
            ...
            "\n"
            "  from madagascar.sdk import Agent, LLM\n"
            ...
            "https://docs.madagascar.dev/sdk/guides/context-condenser\n"
            "=" * 80
        )
