...
This adapter maps FastMCP's token/client-info/expiry keys onto Madagascar
...
from madagascar.agent_server.persistence import PersistedSettings, get_settings_store
...
from madagascar.sdk.mcp.utils import create_mcp_tools
