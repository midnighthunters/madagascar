"""Sub-agents router for Madagascar Agent Server.
...
from madagascar.tools.preset.default import discover_builtin_agents
...
class SubAgentsRequest(BaseModel):
    ...
    load_user: bool = Field(
        default=True,
        description="Load user agents from ~/.agents/agents and ~/.madagascar/agents",
    )
