...
from madagascar.sdk import LLM, Message
...
from madagascar.sdk.settings import ACPAgentSettings, MadagascarAgentSettings
from madagascar.sdk.workspace import LocalWorkspace


_MODEL_PREFIX = "madagascar_"
...
def _profile_name_from_model(model: str) -> str:
    ...
    raise HTTPException(
        ...
        detail=f"Unknown Madagascar model '{model}'. Use GET /v1/models.",
    )
...
def _with_profile_llm_and_system_text(
    ...
    if isinstance(updated, MadagascarAgentSettings):
