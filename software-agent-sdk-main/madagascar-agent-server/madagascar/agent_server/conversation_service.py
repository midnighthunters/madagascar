...
from madagascar.agent_server.event_service import (
...
from madagascar.agent_server.server_details_router import update_last_execution_time
from madagascar.agent_server.skills_service import discover_profile_skills
from madagascar.agent_server.utils import safe_rmtree, utc_now
from madagascar.sdk import LLM, AgentContext, Event, Message
...
from madagascar.sdk.conversation.title_utils import (
...
from madagascar.sdk.git.utils import run_git_command, validate_git_repository
from madagascar.sdk.mcp.utils import MCPToolProvider
from madagascar.sdk.tool import BROWSER_TOOL_NAME, Tool, is_tool_usable
...
def _create_conversation_worktree(
    ...
    branch = f"madagascar/{conversation_id}"
...
def _resolve_agent_from_profile(
    ...
    """
    from madagascar.agent_server.persistence.store import (
        get_agent_profile_store,
        get_llm_profile_store,
    )
    from madagascar.sdk.profiles.resolver import ProfileNotFound, resolve_agent_profile
    ...
    # Madagascar profiles get the discovered catalog minus their ``disabled_skills``
    ...
    if isinstance(settings_config, MadagascarAgentSettings):
...
class ConversationService:
    ...
    def get_instance(cls, config: Config) -> "ConversationService":
        ...
        from madagascar.agent_server.persistence import get_settings_store
