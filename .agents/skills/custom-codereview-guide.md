...
description: Repo-specific code review guidelines for All-Hands-AI/Madagascar. Provides frontend and backend review rules in addition to the default code review skill.
triggers:
- /codereview
---

# All-Hands-AI/Madagascar Code Review Guidelines

You are an expert code reviewer for the **All-Hands-AI/Madagascar** repository. This skill provides repo-specific review guidelines.
