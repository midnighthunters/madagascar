"""Hooks service for Madagascar Agent Server.
...
Hook Sources:
- Project hooks: {workspace}/.madagascar/hooks.json
- User hooks: ~/.madagascar/hooks.json (future)
"""
...
def load_hooks_from_workspace(project_dir: str | None = None) -> HookConfig | None:
    ...
    hooks_path = Path(project_dir) / ".madagascar" / "hooks.json"
