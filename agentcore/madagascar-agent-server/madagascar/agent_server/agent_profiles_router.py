...
reference-bearing :class:`~madagascar.sdk.profiles.AgentProfile` union and keeps a
...
MCP references and returns :class:`~madagascar.sdk.profiles.AgentProfileDiagnostics`
...
from madagascar.agent_server._secrets_exposure import get_cipher, get_config
...
from madagascar.agent_server.profiles_router import MAX_PROFILES, _has_api_key
...
async def materialize_agent_profile(
    ...
    # (catalog minus ``disabled_skills``) resolve. Only Madagascar profiles carry
