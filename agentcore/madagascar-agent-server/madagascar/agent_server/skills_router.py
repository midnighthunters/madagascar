"""Skills router for Madagascar Agent Server.
...
from madagascar.sdk.skills.utils import SKILL_NAME_PATTERN
...
class SkillsRequest(BaseModel):
    ...
    load_public: bool = Field(
        default=True, description="Load public skills from Madagascar/extensions repo"
    )
    load_user: bool = Field(
        default=True, description="Load user skills from ~/.madagascar/skills/"
    )
...
class InstallSkillRequest(BaseModel):
    ...
    source: str = Field(
        ...
        description=(
            ...
            "'github:Madagascar/extensions/skills/github', "
            "'/path/to/skill'"
        ),
    )
    ref: str | None = Field(
...
def get_skills(request: SkillsRequest, http_request: Request) -> SkillsResponse:
    ...
    2. Public skills - From GitHub Madagascar/extensions repository
    3. User skills - From ~/.madagascar/skills/
    4. Organization skills - From {org}/.madagascar or equivalent
    5. Project skills (highest) - From {workspace}/.madagascar/skills/
...
def install_skill_endpoint(request: InstallSkillRequest) -> InstalledSkillResponse:
    ...
    the user's installed skills directory (~/.madagascar/skills/installed/).
...
def list_installed_skills_endpoint() -> InstalledSkillsListResponse:
    ...
    directory (~/.madagascar/skills/installed/).
...
def get_marketplace_catalog() -> MarketplaceCatalogResponse:
    ...
    Returns a list of available skills from the Madagascar extensions
