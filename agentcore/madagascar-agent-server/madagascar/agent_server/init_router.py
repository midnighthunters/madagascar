...
See: https://github.com/Madagascar/software-agent-sdk/issues/2523
"""
...
from madagascar.agent_server.server_details_router import mark_initialization_complete
...
class InitService:
    ...
    async def initialize(self, req: InitRequest) -> InitStatus:
        ...
        try:
            ...
            from madagascar.agent_server.api import _get_root_path
