"""Plugins router for Madagascar Agent Server.
...
from madagascar.sdk.plugin import InstalledPluginInfo, Plugin, PluginFetchError
...
class InstallPluginRequest(BaseModel):
    ...
    source: str = Field(
        ...
        description=(
            ...
            "'github:Madagascar/extensions/plugins/city-weather', '/path/to/plugin'"
        ),
    )
    ref: str | None = Field(
...
def get_marketplace_catalog() -> MarketplaceCatalogResponse:
    ...
    from the Madagascar extensions repository marketplace, each with attachable
