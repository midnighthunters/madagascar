...
from madagascar.sdk import LLM, AgentBase, Event, Message, TextContent, get_logger
...
from madagascar.sdk.conversation.goal.prompts import RESUME_PROMPT
...
from madagascar.sdk.llm.streaming import LLMStreamChunk
from madagascar.sdk.mcp.utils import MCPToolProvider
from madagascar.sdk.security.analyzer import SecurityAnalyzerBase
from madagascar.sdk.security.confirmation_policy import ConfirmationPolicyBase
from madagascar.sdk.utils.async_utils import AsyncCallbackWrapper
...
class EventService:
    ...
    def _event_matches_body(self, event: Event, body: str) -> bool:
        ...
        from madagascar.sdk.llm.message import content_to_str
    ...
    async def start(self):
        ...
        # Hook execution semantics: Madagascar runs hooks sequentially with early-exit
