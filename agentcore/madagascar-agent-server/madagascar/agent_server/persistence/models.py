...
These models mirror the structure used in Madagascar app-server for consistency,
...
class Secrets(BaseModel):
    ...
    Unlike Madagascar app-server which also stores provider tokens,
...
#   madagascar.sdk.settings.api_models (SecretCreateRequest, SecretItemResponse, etc.)
