"""Utility for converting Madagascar SDK events to OpenAI message format.
...
from madagascar.sdk.llm import ImageContent, TextContent, content_to_str
...
def convert_events_to_openai_messages(
    ...
    """Convert Madagascar SDK events to OpenAI message format for LLM APIs.
