...
from madagascar.sdk.critic.base import CriticBase, CriticResult
from madagascar.sdk.critic.impl.api.client import CriticClient
from madagascar.sdk.critic.impl.api.taxonomy import categorize_features
...
class APIBasedCritic(CriticBase, CriticClient):
    ...
    def evaluate(
        ...
        from madagascar.sdk.event import LLMConvertibleEvent, SystemPromptEvent
