...
from madagascar.sdk.llm.utils.madagascar_provider import MADAGASCAR_PROVIDER_PREFIX
...
def _normalized_supported_openai_params(model: str | None) -> frozenset[str]:
    ...
    for provider_prefix in (LITELLM_PROXY_PREFIX, MADAGASCAR_PROVIDER_PREFIX):
