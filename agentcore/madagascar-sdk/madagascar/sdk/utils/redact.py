...
Copies / consumers (keep in sync when changing):
  - Madagascar/runtime-api  →  utils/redact.py  (partial copy)
  - All-Hands-AI/Madagascar →  imports directly
"""
...
_API_KEY_LITERAL_RE = re.compile(
    ...
    r"|sk-oh-[A-Za-z0-9]{20,}"  # Madagascar session tokens
...
def redact_api_key_literals(text: str) -> str:
    ...
    Madagascar session tokens, etc.) anywhere in the text.
