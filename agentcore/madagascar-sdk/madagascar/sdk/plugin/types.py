...
#: See https://github.com/Madagascar/software-agent-sdk/issues/1745 for LSP support.
...
#: See madagascar.sdk.hooks.HookConfig for the full structure.
...
class CommandDefinition(BaseModel):
    ...
    def to_skill(self, plugin_name: str) -> Skill:
        ...
        """
        from madagascar.sdk.skills.skill import Skill
        from madagascar.sdk.skills.trigger import KeywordTrigger
