...
from madagascar.sdk.security import risk
from madagascar.sdk.skills.utils import expand_variable_references
...
from madagascar.sdk.tool.schema import Schema, _process_schema_node
from madagascar.sdk.tool.tool import _prioritize_schema_fields
...
class MCPToolDefinition(ToolDefinition[MCPToolAction, MCPToolObservation]):
    ...
    def action_from_arguments(self, arguments: dict[str, Any]) -> MCPToolAction:
        ...
        # internal to Madagascar and not part of the MCP tool schema
    ...
    def _get_tool_schema(
        ...
        Madagascar-specific fields (``security_risk``, ``summary``) directly.

        See: https://github.com/Madagascar/software-agent-sdk/issues/3955
        """
