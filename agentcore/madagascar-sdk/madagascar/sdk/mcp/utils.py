...
from madagascar.sdk.mcp.exceptions import MCPTimeoutError
...
def _prepare_mcp_config(
    ...
    *,
    ...
    """Validate MCP config and apply explicit Madagascar runtime auth metadata."""
...
def create_mcp_tools(
    ...
    *,
    ...
    """Create MCP tools from Madagascar-native MCP server settings.
