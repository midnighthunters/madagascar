...
from madagascar.sdk.hooks.types import HookDecision, HookEvent
...
class HookExecutor:
    ...
    def _execute_agent_hook(
        ...
        from madagascar.sdk.agent import Agent  # type: ignore[attr-defined]
    ...
    def execute(
        ...
        hook_env["MADAGASCAR_PROJECT_DIR"] = self.working_dir
        hook_env["MADAGASCAR_SESSION_ID"] = event.session_id or ""
        hook_env["MADAGASCAR_EVENT_TYPE"] = event.event_type
        if event.tool_name:
            hook_env["MADAGASCAR_TOOL_NAME"] = event.tool_name
