...
from madagascar.sdk.conversation.persistence_const import BASE_STATE, EVENTS_DIR
...
from madagascar.sdk.io import FileStore, InMemoryFileStore, LocalFileStore
...
class ConversationState(MadagascarModel):
    ...
    agent_state: dict[str, Any] = Field(
        ...
        "See https://docs.madagascar.dev/sdk/guides/convo-persistence#how-state-persistence-works",
    )
