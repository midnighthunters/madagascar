...
from madagascar.sdk.agent.acp_agent import ACPAgent as ACPAgent
from madagascar.sdk.agent.agent import Agent as Agent
...
from madagascar.sdk.utils.models import kind_of
...
class StartConversationRequest(BaseModel):
    ...
    Madagascar agents and ACP agents. Clients may provide either a concrete
    ...
    title_llm_profile: str | None = Field(
        ...
        description=(
            ...
            "is loaded from LLMProfileStore (~/.madagascar/profiles/) and used "
...
class StartACPConversationRequest(StartConversationRequest):
    ...
    Madagascar agents and ACP agents through the same request contract.
    """
