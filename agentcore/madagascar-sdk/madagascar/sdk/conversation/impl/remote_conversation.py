...
from madagascar.sdk.conversation.base import BaseConversation, ConversationStateProtocol
...
from madagascar.sdk.conversation.exceptions import (
...
from madagascar.sdk.event.conversation_state import (
    FULL_STATE_KEY,
    ConversationStateUpdateEvent,
)
from madagascar.sdk.event.llm_completion_log import LLMCompletionLogEvent
from madagascar.sdk.event.types import EventID
...
from madagascar.sdk.tool.client_tool import ClientTool, ClientToolSpec
from madagascar.sdk.utils.redact import http_error_log_content
from madagascar.sdk.workspace import LocalWorkspace, RemoteWorkspace
...
class RemoteConversation(BaseConversation):
    ...
    def __init__(
        ...
        **_: object,
        ...
        if should_create:
            ...
            from madagascar.sdk.subagent.registry import get_registered_agent_definitions
            from madagascar.sdk.tool.registry import get_tool_module_qualnames
        ...
        ws_timeout = float(os.getenv("MADAGASCAR_REMOTE_WS_READY_TIMEOUT", "30"))
        if not self._ws_client.wait_until_ready(timeout=ws_timeout):
            if os.getenv("MADAGASCAR_REMOTE_WS_READY_REQUIRED", "true").lower() in (
                "0",
                "false",
                "no",
            ):
                logger.warning(
                    ...
                    "reconciliation because MADAGASCAR_REMOTE_WS_READY_REQUIRED "
                    "is false.",
                    ws_timeout,
                    self._id,
                )
    ...
    def update_secrets(self, secrets: Mapping[str, SecretValue]) -> None:
        from madagascar.sdk.secret.secrets import SecretSource
