...
from madagascar.sdk.context.prompts.section import PromptContext
...
from madagascar.sdk.secret import SecretSource, SecretValue
...
class AgentContext(BaseModel):
    ...
    load_user_skills: bool = Field(
        default=False,
        description=(
            "Whether to automatically load user skills from ~/.madagascar/skills/ "
            "and ~/.madagascar/microagents/ (for backward compatibility). "
        ),
        json_schema_extra={"acp_compatible": True},
    )
    load_public_skills: bool = Field(
        default=False,
        description=(
            "Whether to automatically load skills from the public Madagascar "
            "skills repository at https://github.com/Madagascar/extensions. "
    ...
    load_project_skills: bool = Field(
        ...
        description=(
            ...
            "workspace (e.g. .madagascar/skills/, AGENTS.md). Unlike "
