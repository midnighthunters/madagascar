...
from madagascar.sdk.tool.schema import Action, Observation, Schema
...
class ToolAnnotations(BaseModel):
    ...
    model_config: ClassVar[ConfigDict] = ConfigDict(
        ...
        title="madagascar.sdk.tool.tool.ToolAnnotations",
    )
    ...
    def __call__(
        ...
        Args:
            ...
            conversation: The conversation context for the tool execution.
                         ...
                         tool execution. See https://github.com/Madagascar/agent-sdk/pull/925
                         for more details.
...
class ToolDefinition[ActionT, ObservationT](DiscriminatedUnionMixin, ABC):
    ...
    def resolve_kind(cls, kind: str) -> type:
        ...
        error_msg = (
            ...
            f"MadagascarModel instead of BaseModel to make sure that an invalid "
