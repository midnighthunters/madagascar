#!/usr/bin/env python3
"""Trigger, compare, and report on Madagascar evaluation runs.
...
DASHBOARD_BASE = "https://madagascar-eval-monitor.vercel.app"

SDK_REPO = "Madagascar/software-agent-sdk"
BENCHMARKS = [
    "swebench",
    "swebenchpro",
    "gaia",
...
def cmd_compare(args: argparse.Namespace) -> None:
    ...
    if args.post_comment:
        ...
        body = (
            ...
            + "(Madagascar) on behalf of the user.*\n"
        )
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Trigger, compare, and report on Madagascar evaluation runs",
    )
