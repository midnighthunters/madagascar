...
The Terminal Tool provides a persistent shell session for executing bash commands within the Madagascar SDK.
...
```python
from madagascar.sdk import Conversation
...
```python
from madagascar.sdk import Conversation
from madagascar.tools.terminal.definition import TerminalTool, TerminalAction
