"""Default preset configuration for Madagascar agents."""

from pathlib import Path

from madagascar.sdk import Agent, agent_definition_to_factory, load_agents_from_dir
from madagascar.sdk.context.condenser import default_condenser
...
from madagascar.sdk.subagent import AgentDefinition, register_agent_if_absent
