...
class DockerWorkspace(RemoteWorkspace):
    ...
    This workspace creates a Docker container running a pre-built Madagascar agent
    ...
    Example:
        with DockerWorkspace(
            server_image="ghcr.io/madagascar/agent-server:latest"
        ) as workspace:
    ...
    server_image: str | None = Field(
        default="ghcr.io/madagascar/agent-server:latest-python",
