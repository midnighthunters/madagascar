...
class APIRemoteWorkspace(RemoteWorkspace):
    """Remote workspace using Madagascar runtime API.
    ...
    Example:
        workspace = APIRemoteWorkspace(
            ...
            server_image="ghcr.io/madagascar/agent-server:lastest-python",
        )
    """  # noqa: E501
    ...
    def _start_runtime(self) -> None:
        ...
        if self.target_type == "binary":
            executable = "/usr/local/bin/madagascar-agent-server"
        else:
            executable = "/agent-server/.venv/bin/python -m madagascar.agent_server"
