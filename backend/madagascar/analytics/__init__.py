"""Madagascar analytics package.

Provides a module-level singleton pattern for the AnalyticsService.

Usage::

    from madagascar.analytics import init_analytics_service, get_analytics_service
...
from madagascar.analytics.analytics_service import AnalyticsService
