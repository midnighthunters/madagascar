...
# Note: This module does NOT include middleware setup. Use madagascar.server.listen or
# madagascar.app_server.app directly for the fully configured application.

from madagascar.app_server.app import (
    app,
