"""Config router for Madagascar App Server V1 API.
...
from madagascar.app_server.config import depends_llm_model_service
from madagascar.app_server.config_api.config_models import LLMModelPage, ProviderPage
...
async def search_providers(
    ...
    Each provider indicates whether it is verified by Madagascar.
    """
