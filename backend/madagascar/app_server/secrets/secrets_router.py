"""Secrets router for Madagascar App Server.
...
from madagascar.app_server.secrets.secrets_models import (
    CustomSecretCreate,
    CustomSecretPage,
...
from madagascar.app_server.utils.models import EditResponse
...
async def search_custom_secrets(
    ...
    In SaaS mode, includes the system-generated MADAGASCAR_API_KEY which cannot be deleted.
