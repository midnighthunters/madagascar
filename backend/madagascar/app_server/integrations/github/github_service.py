...
from madagascar.app_server.integrations.github.service import (
    GitHubBranchesMixin,
    GitHubFeaturesMixin,
    GitHubPRsMixin,
    GitHubReposMixin,
...
class GitHubService(
    ...
    This is an extension point in Madagascar that allows applications to customize GitHub
...
github_service_cls = os.environ.get(
    'MADAGASCAR_GITHUB_SERVICE_CLS',
    'madagascar.app_server.integrations.github.github_service.GitHubService',
)
