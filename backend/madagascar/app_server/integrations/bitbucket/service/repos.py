...
from madagascar.app_server.integrations.bitbucket.service.base import BitBucketMixinBase
from madagascar.app_server.integrations.service_types import Repository, SuggestedTask
