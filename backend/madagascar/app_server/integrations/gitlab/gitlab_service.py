...
from madagascar.app_server.integrations.gitlab.service import (
    GitLabBranchesMixin,
    GitLabFeaturesMixin,
    GitLabPRsMixin,
    GitLabReposMixin,
...
class GitLabService(
    ...
    This is an extension point in Madagascar that allows applications to customize GitLab
...
gitlab_service_cls = os.environ.get(
    'MADAGASCAR_GITLAB_SERVICE_CLS',
    'madagascar.app_server.integrations.gitlab.gitlab_service.GitLabService',
)
