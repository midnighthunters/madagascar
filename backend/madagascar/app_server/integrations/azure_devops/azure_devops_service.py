...
from madagascar.app_server.integrations.azure_devops.service.branches import (
    AzureDevOpsBranchesMixin,
)
from madagascar.app_server.integrations.azure_devops.service.features import (
    AzureDevOpsFeaturesMixin,
)
from madagascar.app_server.integrations.azure_devops.service.prs import (
    AzureDevOpsPRsMixin,
)
from madagascar.app_server.integrations.azure_devops.service.repos import (
    AzureDevOpsReposMixin,
)
from madagascar.app_server.integrations.azure_devops.service.resolver import (
...
from madagascar.app_server.integrations.azure_devops.service.work_items import (
    AzureDevOpsWorkItemsMixin,
)
from madagascar.app_server.integrations.protocols.http_client import HTTPClient
...
class AzureDevOpsService(
    ...
    This is an extension point in Madagascar that allows applications to customize Azure DevOps
    integration behavior. Applications can substitute their own implementation by:
    1. Creating a class that inherits from GitService
    2. Implementing all required methods
    3. Setting MADAGASCAR_AZURE_DEVOPS_SERVICE_CLS environment variable
...
azure_devops_service_cls = os.environ.get(
    'MADAGASCAR_AZURE_DEVOPS_SERVICE_CLS',
    'madagascar.app_server.integrations.azure_devops.azure_devops_service.AzureDevOpsService',
)
