# Madagascar App Server

FastAPI-based application server that provides REST API endpoints for Madagascar V1 integration.

## Overview

This package provides server and sandbox functionality to interact with the Madagascar Software Agent SDK. It exposes REST API endpoints for managing conversations, sandboxes, events, and user settings.
