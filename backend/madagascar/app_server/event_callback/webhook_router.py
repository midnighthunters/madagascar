"""Event Callback router for Madagascar App Server."""
...
from madagascar import tools  # type: ignore[attr-defined]
...
from madagascar.app_server import shared
...
from madagascar.app_server.user_auth.default_user_auth import DefaultUserAuth
from madagascar.app_server.user_auth.user_auth import (
    get_for_user as get_user_auth_for_user,
)
from madagascar.sdk import ConversationExecutionStatus, Event
from madagascar.sdk.event import ConversationStateUpdateEvent, ObservationEvent
from madagascar.sdk.settings import ACPAgentSettings
from madagascar.sdk.settings.acp_providers import detect_acp_provider_by_command
from madagascar.sdk.tool.builtins import SwitchLLMObservation
...
async def on_conversation_update(
    ...
    union so both Madagascar (``Agent``) and ACP (``ACPAgent``) payloads are
