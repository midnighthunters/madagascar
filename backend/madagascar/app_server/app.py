...
from madagascar.app_server import v1_router
from madagascar.app_server.config import get_app_lifespan_service
from madagascar.app_server.integrations.service_types import AuthenticationError
from madagascar.app_server.mcp.mcp_router import init_tavily_proxy, mcp_server
...
from madagascar.app_server.static import SPAStaticFiles
from madagascar.app_server.status.status_router import router as health_router
...
app = FastAPI(
    title='Madagascar',
    description='Madagascar: Code Less, Make More',
    version=get_version(),
