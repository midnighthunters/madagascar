"""Settings models for Madagascar App Server.

This module contains:
- Settings: Persisted settings for Madagascar sessions
...
class MarketplaceRegistration(BaseModel):
    ...
    Wire-compatible with ``madagascar.sdk.marketplace.MarketplaceRegistration``
...
def _load_persisted_agent_settings(
    ...
    ``agent_kind: 'llm'`` tag to ``'madagascar'``, and validates against the
...
class Settings(BaseModel):
    """Persisted settings for Madagascar sessions.
    ...
    def update(self, payload: dict[str, Any]) -> None:
        ...
        if isinstance(agent_update, dict):
            ...
            # config preservation tracked in Madagascar/Madagascar#14370.
    ...
    def agent_settings_serializer(
        self,
        agent_settings: MadagascarAgentSettings | ACPAgentSettings,
    ...
    def _normalize_inputs(cls, data: dict | object) -> dict | object:
        ...
        elif isinstance(agent_settings, (MadagascarAgentSettings, ACPAgentSettings)):
    ...
    def to_agent_settings(self) -> MadagascarAgentSettings | ACPAgentSettings:
