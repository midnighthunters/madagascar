...
from madagascar.app_server.app_conversation import app_conversation_router
from madagascar.app_server.config_api.config_router import router as config_router
from madagascar.app_server.event import event_router
from madagascar.app_server.event_callback import (
    webhook_router,
)
from madagascar.app_server.git.git_router import router as git_router
from madagascar.app_server.pending_messages.pending_message_router import (
    router as pending_message_router,
)
from madagascar.app_server.sandbox import sandbox_router, sandbox_spec_router
...
from madagascar.app_server.user import skills_router, user_router
from madagascar.app_server.web_client import web_client_router
