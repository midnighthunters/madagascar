"""Git router for Madagascar App Server V1 API.
...
in madagascar/server/routes/git.py.
"""
...
from madagascar.app_server.config import depends_user_context, get_global_config
from madagascar.app_server.git.git_models import (
    BranchPage,
    InstallationPage,
    RepositoryPage,
    SortOrder,
...
from madagascar.app_server.utils.paging_utils import (
    decode_page_id,
    encode_page_id,
    paginate_results,
)
