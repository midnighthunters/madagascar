...
from madagascar.app_server.sandbox.preset_sandbox_spec_service import (
...
class TestDockerSandboxSpecServiceInjector:
    ...
    @patch('madagascar.app_server.sandbox.docker_sandbox_spec_service.get_docker_client')
    ...
    def test_get_default_sandbox_specs(self):
        ...
        assert specs[0].id.startswith('ghcr.io/madagascar/agent-server:')
    ...
    @patch(
        'madagascar.app_server.sandbox.docker_sandbox_spec_service._global_docker_client',
        None,
    )
    ...
    def test_get_docker_client_reuses_existing_client(
        ...
        import madagascar.app_server.sandbox.docker_sandbox_spec_service as module
    ...
    @patch('madagascar.app_server.sandbox.docker_sandbox_spec_service.get_docker_client')
    @patch('madagascar.app_server.sandbox.docker_sandbox_spec_service._logger')
