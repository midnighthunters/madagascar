...
def test_extract_label_names_normalizes_issue_labels():
    module = load_module('issue_good_first_issue_check_madagascar.py')
...
def test_build_prompt_includes_issue_labels_and_criteria():
    ...
    prompt = module.build_prompt(
        'Madagascar/Madagascar',
        {
            ...
            'html_url': 'https://github.com/Madagascar/Madagascar/issues/123',
...
def test_good_first_issue_main_writes_result_from_final_response(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(
        ...
        lambda: argparse.Namespace(
            repository='Madagascar/Madagascar',
            issue_number=123,
    ...
    assert result['repository'] == 'Madagascar/Madagascar'
