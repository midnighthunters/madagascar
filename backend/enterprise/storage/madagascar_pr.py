...
class MadagascarPR(Base):
    """
    Represents a pull request created by Madagascar.
    """

    __tablename__ = 'madagascar_prs'
    ...
    madagascar_helped_author: Mapped[bool | None] = mapped_column(nullable=True)
    num_madagascar_commits: Mapped[int | None] = mapped_column(nullable=True)
    num_madagascar_review_comments: Mapped[int | None] = mapped_column(nullable=True)
    num_madagascar_general_comments: Mapped[int | None] = mapped_column(nullable=True)
