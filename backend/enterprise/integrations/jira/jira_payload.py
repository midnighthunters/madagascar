...
class JiraPayloadParser:
    ...
    def __init__(self, oh_label: str, inline_oh_label: str):
        """Initialize parser with Madagascar label configuration.

        Args:
            oh_label: Label that triggers Madagascar (e.g., 'madagascar')
            inline_oh_label: Mention that triggers Madagascar (e.g., '@madagascar')
        """
    ...
    def _has_mention(self, text: str) -> bool:
        """Check if text contains an exact mention of Madagascar."""
