...
def setup_all_loggers():
    ...
    Leave Madagascar alone since it's already configured.
    """
    if LOG_JSON:
...
setup_all_loggers()
# Madagascar logger is heavily customized - so we want to make sure that it is logging json
setup_json_logger(madagascar_logger)
