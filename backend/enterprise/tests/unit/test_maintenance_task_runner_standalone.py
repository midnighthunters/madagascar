...
These tests work without Madagascar dependencies and focus on testing the core
...
class TestMaintenanceTaskRunnerStandalone:
    """Standalone tests for MaintenanceTaskRunner without Madagascar dependencies."""
